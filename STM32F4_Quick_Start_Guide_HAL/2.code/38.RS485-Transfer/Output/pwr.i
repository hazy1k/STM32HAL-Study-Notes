# 1 "../User/BSP/pwr/pwr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/pwr/pwr.c" 2
...
# 5 "../User/BSP/pwr/pwr.h" 2

void pwr_wkup_key_init(void);
void pwr_enter_sleep(void);
void pwr_enter_stop(void);
void pwr_enter_standby(void);
# 2 "../User/BSP/pwr/pwr.c" 2
...
{
    HAL_SuspendTick();
    HAL_PWR_EnterSLEEPMode(0x00000000U, ((uint8_t)0x01));
}
...
void pwr_enter_stop(void)
{
    ...
    HAL_SuspendTick();
    HAL_PWR_EnterSTOPMode((0x1UL << (0U)), ((uint8_t)0x01));
}
...
void pwr_enter_standby(void)
{
    ...
    (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR |= ((0x1UL << (1U))) << 2U);
# 69 "../User/BSP/pwr/pwr.c"

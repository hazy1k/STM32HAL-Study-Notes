# 1 "../User/BSP/adc/adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/adc/adc.c" 2
...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
    if (hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL)))
    {
        ...
        GPIO_InitStructure.Pin = ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0004) |
                              ((uint16_t)0x0008) | ((uint16_t)0x0010) | ((uint16_t)0x0020);
...
void adc_set_channel_config(ADC_HandleTypeDef *hadc, uint32_t channel, uint32_t rank, uint32_t sample_time)
{
    ...
    adc_channel_config.SamplingTime = sample_time;
...
void adc_multi_channel_dma_init(void)
{
    ...
    g_adc_handle.Instance = ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL));
    g_adc_handle.Init.ClockPrescaler = ((uint32_t)(0x1UL << (16U)));
    g_adc_handle.Init.Resolution = 0x00000000U;
    g_adc_handle.Init.DataAlign = 0x00000000U;
    ...
    g_adc_handle.Init.NbrOfConversion = 6;
    g_adc_handle.Init.NbrOfDiscConversion = 0;
    g_adc_handle.Init.ExternalTrigConv = ((uint32_t)(0xFUL << (24U)) + 1U);
    g_adc_handle.Init.ExternalTrigConvEdge = 0x00000000U;
    g_adc_handle.Init.DMAContinuousRequests = ENABLE;
    HAL_ADC_Init(&g_adc_handle);


    g_dma_adc_handle.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x070UL));
    g_dma_adc_handle.Init.Channel = 0x00000000U;
    g_dma_adc_handle.Init.Direction = 0x00000000U;
    g_dma_adc_handle.Init.PeriphInc = 0x00000000U;
    g_dma_adc_handle.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    g_dma_adc_handle.Init.PeriphDataAlignment = ((uint32_t)(0x1UL << (11U)));
    g_dma_adc_handle.Init.MemDataAlignment = ((uint32_t)(0x1UL << (13U)));
    g_dma_adc_handle.Init.Mode = ((uint32_t)(0x1UL << (8U)));
    g_dma_adc_handle.Init.Priority = ((uint32_t)(0x2UL << (16U)));
    g_dma_adc_handle.Init.FIFOMode = 0x00000000U;
    HAL_DMA_Init(&g_dma_adc_handle);


    do{ (&g_adc_handle)->DMA_Handle = &(g_dma_adc_handle); (g_dma_adc_handle).Parent = (&g_adc_handle); } while(0U);


    adc_set_channel_config(&g_adc_handle, 0x00000000U, 1, ((uint32_t)(0x7UL << (0U))));
    adc_set_channel_config(&g_adc_handle, ((uint32_t)(0x01UL << (0U))), 2, ((uint32_t)(0x7UL << (0U))));
    adc_set_channel_config(&g_adc_handle, ((uint32_t)(0x02UL << (0U))), 3, ((uint32_t)(0x7UL << (0U))));
    adc_set_channel_config(&g_adc_handle, ((uint32_t)((0x02UL << (0U)) | (0x01UL << (0U)))), 4, ((uint32_t)(0x7UL << (0U))));
    adc_set_channel_config(&g_adc_handle, ((uint32_t)(0x04UL << (0U))), 5, ((uint32_t)(0x7UL << (0U))));
    adc_set_channel_config(&g_adc_handle, ((uint32_t)((0x04UL << (0U)) | (0x01UL << (0U)))), 6, ((uint32_t)(0x7UL << (0U))));
...
void adc_multi_channel_dma_enable(uint16_t num_transfers)
{
    ...
    ((g_adc_handle.Instance->CR2) |= ((0x1UL << (30U))));
}
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc)
{
    if (hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL)))
    {
        ...
        callback_count++;
        g_adc_dma_transfer_complete_flag = 1;

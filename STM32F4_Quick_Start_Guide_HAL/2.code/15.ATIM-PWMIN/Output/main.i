...
extern uint8_t PWMIN_STA;
extern uint16_t PWMIN_PSC;
extern uint32_t PWMIN_Highvlaue;
extern uint32_t PWMIN_CycleTime;
...
int main(void)
{
    ...
    ((TIM_TypeDef *) (0x40000000UL + 0x2000UL))->CCR1 = 2;

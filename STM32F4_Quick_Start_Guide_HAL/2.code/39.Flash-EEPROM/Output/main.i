...
# 1 "../User/BSP/stmflash\\stmflash.h" 1
# 25 "../User/BSP/stmflash\\stmflash.h"
...
# 58 "E:\\dianzi\\MDKv5\\ARM\\ARMCLANG\\Bin\\..\\include\\string.h" 3
...
int main(void)
{
    uint8_t key_value = 0;
    uint16_t i = 0;
    uint8_t databuf[((sizeof(text_buf) + 3) / 4) * 4];
    ...
    memcpy(databuf, text_buf, sizeof(text_buf));
    ...
    while(1)
    {
        ...
        if(key_value == 1)
        {
            LCD_Fill(30,150,240,190,0xFFFF);
            LCD_ShowString(30,150,200,16,16,"Start Write FLASH....");
            stmflash_write(0x08010000, (uint32_t*)databuf, ((sizeof(text_buf) + 3) / 4));
        ...
        else if(key_value == 2)
        {
            ...
            memset(databuf, 0, sizeof(databuf));
            stmflash_read(0x08010000, (uint32_t*)databuf, ((sizeof(text_buf) + 3) / 4));
        ...
        else if(key_value == 3)
        {
            ...
            stmflash_erase_sector(stmflash_get_flash_sector(0x08010000));

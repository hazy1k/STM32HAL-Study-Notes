# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c" 2
# 102 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
...
# 103 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c" 2
# 164 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_StatusTypeDef HAL_PCCARD_Init(PCCARD_HandleTypeDef *hpccard, FSMC_NAND_PCC_TimingTypeDef *ComSpaceTiming, FSMC_NAND_PCC_TimingTypeDef *AttSpaceTiming, FSMC_NAND_PCC_TimingTypeDef *IOSpaceTiming)
{
...
# 187 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
  ...
  ((hpccard->Instance)->PCR4 |= (0x1UL << (2U)));
...
HAL_StatusTypeDef HAL_PCCARD_DeInit(PCCARD_HandleTypeDef *hpccard)
{
# 234 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
  ...
  do{ (hpccard)->Lock = HAL_UNLOCKED; }while (0U);
...
__attribute__((weak)) void HAL_PCCARD_MspInit(PCCARD_HandleTypeDef *hpccard)
{
...
__attribute__((weak)) void HAL_PCCARD_MspDeInit(PCCARD_HandleTypeDef *hpccard)
{
...
# 306 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_StatusTypeDef HAL_PCCARD_Read_ID(PCCARD_HandleTypeDef *hpccard, uint8_t CompactFlash_ID[], uint8_t *pStatus)
{
  uint32_t timeout = 0x0000FFFFU, index = 0U;
  uint8_t status = 0;


  do{ if((hpccard)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hpccard)->Lock = HAL_LOCKED; } }while (0U);
  ...
  *pStatus = ((uint8_t)0x40);


  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x07)) = 0xECEC;


  do
  {

     status = *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x0E));

     timeout--;
  }while((status != (uint8_t)0x58) && timeout);

  if(timeout == 0U)
  {
    *pStatus = ((uint8_t)0x60);
  }
  else
  {
    ...
    {
      CompactFlash_ID[index] = *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x00));
    }
  }
...
# 369 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_StatusTypeDef HAL_PCCARD_Read_Sector(PCCARD_HandleTypeDef *hpccard, uint16_t *pBuffer, uint16_t SectorAddress, uint8_t *pStatus)
{
  uint32_t timeout = 0x0000FFFFU, index = 0U;
  uint8_t status = 0;
  ...
  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x05)) = (uint16_t)0x00;
  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x02)) = ((uint16_t)0x0100) | ((uint16_t)SectorAddress);
  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x07)) = (uint16_t)0xE4A0;

  do
  {

    status = *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x0E));
    timeout--;
  ...
  {
    *(uint16_t *)pBuffer++ = *(uint16_t *)(0x9C0001F0U);
  }
...
# 445 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_StatusTypeDef HAL_PCCARD_Write_Sector(PCCARD_HandleTypeDef *hpccard, uint16_t *pBuffer, uint16_t SectorAddress, uint8_t *pStatus)
{
  uint32_t timeout = 0x0000FFFFU, index = 0U;
  uint8_t status = 0;
  ...
  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x05)) = (uint16_t)0x00;
  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x02)) = ((uint16_t)0x0100) | ((uint16_t)SectorAddress);
  *(volatile uint16_t *)(0x9C0001F0U | ((uint8_t)0x07)) = (uint16_t)0x30A0;
  ...
  for(; index < 255U; index++)
  {
    *(uint16_t *)(0x9C0001F0U) = *(uint16_t *)pBuffer++;
  }
  ...
  do
  {
    ...
    status = *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x0E));
    timeout--;
  }while((status != (uint8_t)0x50) && timeout);
...
# 518 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_StatusTypeDef HAL_PCCARD_Erase_Sector(PCCARD_HandleTypeDef *hpccard, uint16_t SectorAddress, uint8_t *pStatus)
{
  uint32_t timeout = 0x00000400U;
  uint8_t status = 0;
  ...
  *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x04)) = 0x00;
  *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x05)) = 0x00;
  *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x03)) = SectorAddress;
  *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x02)) = 0x01;
  *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x06)) = 0xA0;
  *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x07)) = ((uint8_t)0xC0);
...
# 594 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
  hpccard->State = HAL_PCCARD_STATE_BUSY;

  *(volatile uint8_t *)(0x98000000U | ((uint16_t)0x0202) ) = 0x01;
...
void HAL_PCCARD_IRQHandler(PCCARD_HandleTypeDef *hpccard)
{
  ...
  if((((hpccard->Instance)->SR4 &(0x00000001U)) == (0x00000001U)))
  {
    ...
    ((hpccard->Instance)->SR4 &= ~(0x00000001U));
  }


  if((((hpccard->Instance)->SR4 &(0x00000002U)) == (0x00000002U)))
  {
    ...
    ((hpccard->Instance)->SR4 &= ~(0x00000002U));
  }


  if((((hpccard->Instance)->SR4 &(0x00000004U)) == (0x00000004U)))
  {
    ...
    ((hpccard->Instance)->SR4 &= ~(0x00000004U));
  }


  if((((hpccard->Instance)->SR4 &(0x00000040U)) == (0x00000040U)))
  {
    ...
    ((hpccard->Instance)->SR4 &= ~(0x00000040U));
  }
}
...
__attribute__((weak)) void HAL_PCCARD_ITCallback(PCCARD_HandleTypeDef *hpccard)
{
...
# 848 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_PCCARD_StateTypeDef HAL_PCCARD_GetState(PCCARD_HandleTypeDef *hpccard)
{
  return hpccard->State;
}
# 862 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_PCCARD_StatusTypeDef HAL_PCCARD_GetStatus(PCCARD_HandleTypeDef *hpccard)
{
  uint32_t timeout = 0x01000000U, status_pccard = 0U;
  ...
  status_pccard = *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x0E));

  while((status_pccard == ((uint8_t)0x80)) && timeout)
  {
    status_pccard = *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x0E));
    timeout--;
  }
  ...
  if(timeout == 0U)
  {
    status_pccard = ((uint8_t)0x60);
  }


  return (HAL_PCCARD_StatusTypeDef) status_pccard;
}
# 898 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pccard.c"
HAL_PCCARD_StatusTypeDef HAL_PCCARD_ReadStatus(PCCARD_HandleTypeDef *hpccard)
{
  uint8_t data = 0U, status_pccard = ((uint8_t)0x80);
  ...
  data = *(volatile uint8_t *)(0x9C0001F0U | ((uint8_t)0x0E));

  if((data & ((uint8_t)0x60)) == ((uint8_t)0x60))
  {
    status_pccard = ((uint8_t)0x60);
  }
  else if((data & ((uint8_t)0x40)) == ((uint8_t)0x40))
  {
    status_pccard = ((uint8_t)0x40);
  }

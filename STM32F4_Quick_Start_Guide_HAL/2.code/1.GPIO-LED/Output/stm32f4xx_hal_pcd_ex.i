...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd_ex.c" 2
...
# 26 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd_ex.c" 2
# 71 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd_ex.c"
HAL_StatusTypeDef HAL_PCDEx_SetTxFiFo(PCD_HandleTypeDef *hpcd, uint8_t fifo, uint16_t size)
{
  uint8_t i;
  uint32_t Tx_Offset;
# 86 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd_ex.c"
...
# 302 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd_ex.c"

...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c" 2
# 202 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
...
# 203 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c" 2
# 227 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
...
# 292 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Init(IRDA_HandleTypeDef *hirda)
{
...
# 322 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
  ...
  ((hirda->Instance->CR2) &= ~(((0x1UL << (14U)) | (0x3UL << (12U)) | (0x1UL << (11U)))));
  ((hirda->Instance->CR3) &= ~(((0x1UL << (5U)) | (0x1UL << (3U)))));


  ((((hirda)->Instance->CR1) |= ((0x1UL << (13U)))));


  (((hirda->Instance->GTPR)) = ((((((hirda->Instance->GTPR))) & (~((0xFFUL << (0U))))) | (hirda->Init.Prescaler))));


  (((hirda->Instance->CR3)) = ((((((hirda->Instance->CR3))) & (~((0x1UL << (2U))))) | (hirda->Init.IrDAMode))));


  ((hirda->Instance->CR3) |= ((0x1UL << (1U))));


  hirda->ErrorCode = 0x00000000U;
...
# 391 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
  ...
  do{ (hirda)->Lock = HAL_UNLOCKED; }while (0U);
...
__attribute__((weak)) void HAL_IRDA_MspInit(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_MspDeInit(IRDA_HandleTypeDef *hirda)
{
...
HAL_StatusTypeDef HAL_IRDA_Transmit(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hirda->gState == HAL_IRDA_STATE_READY)
  {
    ...
    do{ if((hirda)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hirda)->Lock = HAL_LOCKED; } }while (0U);
    ...
    {
      hirda->TxXferCount--;
      if (hirda->Init.WordLength == ((uint32_t)(0x1UL << (12U))))
      {
        if (IRDA_WaitOnFlagUntilTimeout(hirda, ((uint32_t)(0x1UL << (7U))), RESET, tickstart, Timeout) != HAL_OK)
        {
          return HAL_TIMEOUT;
        }
        tmp = (uint16_t *) pData;
        hirda->Instance->DR = (*tmp & (uint16_t)0x01FF);
        if (hirda->Init.Parity == 0x00000000U)
        {
          pData += 2U;
        }
        else
    ...
    if (IRDA_WaitOnFlagUntilTimeout(hirda, ((uint32_t)(0x1UL << (6U))), RESET, tickstart, Timeout) != HAL_OK)
    {
      return HAL_TIMEOUT;
    }
...
# 855 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Receive(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint16_t *tmp;
  uint32_t tickstart = 0U;
  ...
  if (hirda->RxState == HAL_IRDA_STATE_READY)
  {
    ...
    while (hirda->RxXferCount > 0U)
    {
      ...
      if (hirda->Init.WordLength == ((uint32_t)(0x1UL << (12U))))
      {
        if (IRDA_WaitOnFlagUntilTimeout(hirda, ((uint32_t)(0x1UL << (5U))), RESET, tickstart, Timeout) != HAL_OK)
        {
          return HAL_TIMEOUT;
        }
        tmp = (uint16_t *) pData ;
...
# 945 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Transmit_IT(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
...
HAL_StatusTypeDef HAL_IRDA_Receive_IT(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  ...
  if (hirda->RxState == HAL_IRDA_STATE_READY)
  {
    ...
    ((hirda->Instance->CR1) |= ((0x1UL << (8U)) | (0x1UL << (5U))));


    ((hirda->Instance->CR3) |= ((0x1UL << (0U))));
...
# 1038 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Transmit_DMA(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  uint32_t *tmp;
  ...
  if (hirda->gState == HAL_IRDA_STATE_READY)
  {
    ...
    hirda->hdmatx->XferAbortCallback = 0;
    ...
    ((hirda)->Instance->SR = ~(((uint32_t)(0x1UL << (6U)))));
...
# 1106 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Receive_DMA(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  uint32_t *tmp;
  ...
  if (hirda->RxState == HAL_IRDA_STATE_READY)
  {
    ...
    hirda->hdmarx->XferAbortCallback = 0;
    ...
    do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (hirda)->Instance->SR; tmpreg = (hirda)->Instance->DR; (void)tmpreg; } while(0U);


    do{ (hirda)->Lock = HAL_UNLOCKED; }while (0U);


    ((hirda->Instance->CR1) |= ((0x1UL << (8U))));
...
HAL_StatusTypeDef HAL_IRDA_DMAPause(IRDA_HandleTypeDef *hirda)
{
  ...
  dmarequest = (((hirda->Instance->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U))));
  ...
  dmarequest = (((hirda->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))));
...
# 1298 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Abort(IRDA_HandleTypeDef *hirda)
{

  ((hirda->Instance->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U)))));
  ((hirda->Instance->CR3) &= ~((0x1UL << (0U))));


  if ((((hirda->Instance->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U)))))
  {
    ((hirda->Instance->CR3) &= ~((0x1UL << (7U))));
  ...
  if ((((hirda->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))))
  {
    ((hirda->Instance->CR3) &= ~((0x1UL << (6U))));
...
# 1362 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_AbortTransmit(IRDA_HandleTypeDef *hirda)
{

  ((hirda->Instance->CR1) &= ~(((0x1UL << (7U)) | (0x1UL << (6U)))));
...
HAL_StatusTypeDef HAL_IRDA_AbortReceive(IRDA_HandleTypeDef *hirda)
{
  ...
  ((hirda->Instance->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)))));
  ((hirda->Instance->CR3) &= ~((0x1UL << (0U))));
...
# 1449 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_Abort_IT(IRDA_HandleTypeDef *hirda)
{
...
# 1654 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_StatusTypeDef HAL_IRDA_AbortReceive_IT(IRDA_HandleTypeDef *hirda)
{
...
void HAL_IRDA_IRQHandler(IRDA_HandleTypeDef *hirda)
{
  uint32_t isrflags = ((hirda->Instance->SR));
  uint32_t cr1its = ((hirda->Instance->CR1));
  uint32_t cr3its = ((hirda->Instance->CR3));
  ...
  if ((errorflags != RESET) && (((cr3its & (0x1UL << (0U))) != RESET) || ((cr1its & ((0x1UL << (5U)) | (0x1UL << (8U)))) != RESET)))
  {
    ...
    if (hirda->ErrorCode != 0x00000000U)
    {
      ...
      dmarequest = (((hirda->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))));
      if (((hirda->ErrorCode & 0x00000008U) != RESET) || dmarequest)
      {
...
__attribute__((weak)) void HAL_IRDA_TxCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_TxHalfCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_RxCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_RxHalfCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_ErrorCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_AbortCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_AbortTransmitCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
__attribute__((weak)) void HAL_IRDA_AbortReceiveCpltCallback(IRDA_HandleTypeDef *hirda)
{
...
# 2018 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
HAL_IRDA_StateTypeDef HAL_IRDA_GetState(IRDA_HandleTypeDef *hirda)
{
...
# 2077 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
static void IRDA_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
...
# 2227 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
static HAL_StatusTypeDef IRDA_WaitOnFlagUntilTimeout(IRDA_HandleTypeDef *hirda, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
{

  while (((((hirda)->Instance->SR & (Flag)) == (Flag)) ? SET : RESET) == Status)
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if ((Timeout == 0U) || ((HAL_GetTick() - Tickstart) > Timeout))
      {
        ...
        ((hirda->Instance->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)))));
        ((hirda->Instance->CR3) &= ~((0x1UL << (0U))));
...
# 2312 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
static void IRDA_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  IRDA_HandleTypeDef *hirda = (IRDA_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
  ...
  if (hirda->hdmarx != 0)
  {
    if (hirda->hdmarx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
# 2356 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
static void IRDA_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  IRDA_HandleTypeDef *hirda = (IRDA_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
  ...
  if (hirda->hdmatx != 0)
  {
    if (hirda->hdmatx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
# 2400 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
static void IRDA_DMATxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  IRDA_HandleTypeDef *hirda = (IRDA_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 2427 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
static void IRDA_DMARxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  IRDA_HandleTypeDef *hirda = (IRDA_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
static HAL_StatusTypeDef IRDA_Receive_IT(IRDA_HandleTypeDef *hirda)
{
  ...
  if (hirda->RxState == HAL_IRDA_STATE_BUSY_RX)
  {
    uhdata = (uint16_t) ((hirda->Instance->DR));
    if (hirda->Init.WordLength == ((uint32_t)(0x1UL << (12U))))
    {
...
static void IRDA_SetConfig(IRDA_HandleTypeDef *hirda)
{
  ...
  ((hirda->Instance->CR2) &= ~((0x3UL << (12U))));



  ((hirda->Instance->CR1) &= ~(((0x1UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U)))));
  ...
  ((hirda->Instance->CR1) |= ((hirda->Init.WordLength | hirda->Init.Parity | hirda->Init.Mode)));



  ((hirda->Instance->CR3) &= ~(((0x1UL << (8U)) | (0x1UL << (9U)))));
# 2640 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_irda.c"
  if((hirda->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || (hirda->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))
  {
    pclk = HAL_RCC_GetPCLK2Freq();
    ((hirda->Instance->BRR) |= (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*(((uint64_t)(((hirda->Init.BaudRate))))))))/100U) << 4U) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*(((uint64_t)(((hirda->Init.BaudRate)))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(4U*(((uint64_t)((((hirda->Init.BaudRate)))))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0xF0U)) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*(((uint64_t)(((hirda->Init.BaudRate)))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(4U*(((uint64_t)((((hirda->Init.BaudRate)))))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0x0FU))));
  }

# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c" 2
# 159 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
...
# 160 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c" 2
# 179 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
...
# 212 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
HAL_StatusTypeDef SDIO_Init(SDIO_TypeDef *SDIOx, SDIO_InitTypeDef Init)
{
  uint32_t tmpreg = 0;
  ...
  (((SDIOx->CLKCR)) = ((((((SDIOx->CLKCR))) & (~(((uint32_t)((0xFFUL << (0U)) | (0x1UL << (9U)) | (0x1UL << (10U)) | (0x3UL << (11U)) | (0x1UL << (13U)) | (0x1UL << (14U))))))) | (tmpreg))));

  return HAL_OK;
}
# 265 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDIO_ReadFIFO(SDIO_TypeDef *SDIOx)
{
...
# 309 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
HAL_StatusTypeDef SDIO_PowerState_ON(SDIO_TypeDef *SDIOx)
{

  SDIOx->POWER = (0x3UL << (0U));
...
# 343 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDIO_GetPowerState(SDIO_TypeDef *SDIOx)
{
  return (SDIOx->POWER & (0x3UL << (0U)));
}
# 356 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
HAL_StatusTypeDef SDIO_SendCommand(SDIO_TypeDef *SDIOx, SDIO_CmdInitTypeDef *Command)
{
  uint32_t tmpreg = 0;
  ...
  (((SDIOx->CMD)) = ((((((SDIOx->CMD))) & (~(((uint32_t)((0x3FUL << (0U)) | (0x3UL << (6U)) | (0x1UL << (8U)) | (0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (11U))))))) | (tmpreg))));
...
# 403 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDIO_GetResponse(SDIO_TypeDef *SDIOx, uint32_t Response)
{
  uint32_t tmp;
...
# 424 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
HAL_StatusTypeDef SDIO_ConfigData(SDIO_TypeDef *SDIOx, SDIO_DataInitTypeDef* Data)
{
  uint32_t tmpreg = 0;
  ...
  (((SDIOx->DCTRL)) = ((((((SDIOx->DCTRL))) & (~(((uint32_t)((0x1UL << (0U)) | (0x1UL << (1U)) | (0x1UL << (2U)) | (0xFUL << (4U))))))) | (tmpreg))));
...
# 483 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
HAL_StatusTypeDef SDIO_SetSDMMCReadWaitMode(SDIO_TypeDef *SDIOx, uint32_t SDIO_ReadWaitMode)
{
  ...
  (((SDIOx->DCTRL)) = ((((((SDIOx->DCTRL))) & (~((0x1UL << (10U))))) | (SDIO_ReadWaitMode))));

  return HAL_OK;
}
# 518 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDMMC_CmdBlockLength(SDIO_TypeDef *SDIOx, uint32_t BlockSize)
{
  ...
  sdmmc_cmdinit.CmdIndex = 16U;
  sdmmc_cmdinit.Response = (0x1UL << (6U));
  sdmmc_cmdinit.WaitForInterrupt = 0x00000000U;
  sdmmc_cmdinit.CPSM = (0x1UL << (10U));
  (void)SDIO_SendCommand(SDIOx, &sdmmc_cmdinit);


  errorstate = SDMMC_GetCmdResp1(SDIOx, 16U, 5000U);
...
uint32_t SDMMC_CmdReadSingleBlock(SDIO_TypeDef *SDIOx, uint32_t ReadAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 17U, 5000U);
...
uint32_t SDMMC_CmdReadMultiBlock(SDIO_TypeDef *SDIOx, uint32_t ReadAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 18U, 5000U);
...
uint32_t SDMMC_CmdWriteSingleBlock(SDIO_TypeDef *SDIOx, uint32_t WriteAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 24U, 5000U);
...
uint32_t SDMMC_CmdWriteMultiBlock(SDIO_TypeDef *SDIOx, uint32_t WriteAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 25U, 5000U);
...
uint32_t SDMMC_CmdSDEraseStartAdd(SDIO_TypeDef *SDIOx, uint32_t StartAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 32U, 5000U);
...
uint32_t SDMMC_CmdSDEraseEndAdd(SDIO_TypeDef *SDIOx, uint32_t EndAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 33U, 5000U);
...
uint32_t SDMMC_CmdEraseStartAdd(SDIO_TypeDef *SDIOx, uint32_t StartAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 35U, 5000U);
...
uint32_t SDMMC_CmdEraseEndAdd(SDIO_TypeDef *SDIOx, uint32_t EndAdd)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 36U, 5000U);
...
uint32_t SDMMC_CmdErase(SDIO_TypeDef *SDIOx)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 38U, 63000U);
...
uint32_t SDMMC_CmdStopTransfer(SDIO_TypeDef *SDIOx)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 12U, 100000000U);
...
uint32_t SDMMC_CmdSelDesel(SDIO_TypeDef *SDIOx, uint64_t Addr)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 7U, 5000U);
...
uint32_t SDMMC_CmdGoIdleState(SDIO_TypeDef *SDIOx)
{
  ...
  sdmmc_cmdinit.Argument = 0U;
  sdmmc_cmdinit.CmdIndex = 0U;
  sdmmc_cmdinit.Response = 0x00000000U;
  sdmmc_cmdinit.WaitForInterrupt = 0x00000000U;
  sdmmc_cmdinit.CPSM = (0x1UL << (10U));
  (void)SDIO_SendCommand(SDIOx, &sdmmc_cmdinit);
...
uint32_t SDMMC_CmdOperCond(SDIO_TypeDef *SDIOx)
{
  ...
  sdmmc_cmdinit.Argument = 0x000001AAU;
  sdmmc_cmdinit.CmdIndex = 8U;
  sdmmc_cmdinit.Response = (0x1UL << (6U));
  sdmmc_cmdinit.WaitForInterrupt = 0x00000000U;
  sdmmc_cmdinit.CPSM = (0x1UL << (10U));
  (void)SDIO_SendCommand(SDIOx, &sdmmc_cmdinit);
...
# 861 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDMMC_CmdAppCommand(SDIO_TypeDef *SDIOx, uint32_t Argument)
{
  SDIO_CmdInitTypeDef sdmmc_cmdinit;
  uint32_t errorstate;
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 55U, 5000U);

  return errorstate;
}
# 889 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDMMC_CmdAppOperCommand(SDIO_TypeDef *SDIOx, uint32_t Argument)
{
  SDIO_CmdInitTypeDef sdmmc_cmdinit;
  uint32_t errorstate;

  sdmmc_cmdinit.Argument = 0x80100000U | Argument;
  sdmmc_cmdinit.CmdIndex = 41U;
  sdmmc_cmdinit.Response = (0x1UL << (6U));
  sdmmc_cmdinit.WaitForInterrupt = 0x00000000U;
  sdmmc_cmdinit.CPSM = (0x1UL << (10U));
  (void)SDIO_SendCommand(SDIOx, &sdmmc_cmdinit);
...
uint32_t SDMMC_CmdBusWidth(SDIO_TypeDef *SDIOx, uint32_t BusWidth)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 6U, 5000U);
...
uint32_t SDMMC_CmdSendSCR(SDIO_TypeDef *SDIOx)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 51U, 5000U);
...
uint32_t SDMMC_CmdSendCID(SDIO_TypeDef *SDIOx)
{
  ...
  sdmmc_cmdinit.Argument = 0U;
  sdmmc_cmdinit.CmdIndex = 2U;
  sdmmc_cmdinit.Response = (0x3UL << (6U));
  sdmmc_cmdinit.WaitForInterrupt = 0x00000000U;
  sdmmc_cmdinit.CPSM = (0x1UL << (10U));
  (void)SDIO_SendCommand(SDIOx, &sdmmc_cmdinit);
...
uint32_t SDMMC_CmdSetRelAdd(SDIO_TypeDef *SDIOx, uint16_t *pRCA)
{
  ...
  errorstate = SDMMC_GetCmdResp6(SDIOx, 3U, pRCA);
...
uint32_t SDMMC_CmdSendStatus(SDIO_TypeDef *SDIOx, uint32_t Argument)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 13U, 5000U);
...
# 1083 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
uint32_t SDMMC_CmdOpCondition(SDIO_TypeDef *SDIOx, uint32_t Argument)
{
  SDIO_CmdInitTypeDef sdmmc_cmdinit;
  uint32_t errorstate;
...
# 1141 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
static uint32_t SDMMC_GetCmdError(SDIO_TypeDef *SDIOx)
{


  uint32_t count = 5000U * (SystemCoreClock / 8U /1000U);
  ...
  }while(!(((SDIOx)->STA &((0x1UL << (7U)))) != 0U));


  ((SDIOx)->ICR = (((uint32_t)((0x1UL << (0U)) | (0x1UL << (2U)) | (0x1UL << (6U)) | (0x1UL << (7U))))));
...
static uint32_t SDMMC_GetCmdResp1(SDIO_TypeDef *SDIOx, uint8_t SD_CMD, uint32_t Timeout)
{
  ...
  do
  {
    ...
    sta_reg = SDIOx->STA;
  }while(((sta_reg & ((0x1UL << (0U)) | (0x1UL << (6U)) | (0x1UL << (2U)))) == 0U) ||
         ((sta_reg & (0x1UL << (11U))) != 0U ));

  if((((SDIOx)->STA &((0x1UL << (2U)))) != 0U))
  {
    ((SDIOx)->ICR = ((0x1UL << (2U))));

    return 0x00000004U;
  }
  else if((((SDIOx)->STA &((0x1UL << (0U)))) != 0U))
  {
    ((SDIOx)->ICR = ((0x1UL << (0U))));
  ...
  response_r1 = SDIO_GetResponse(SDIOx, 0x00000000U);

  if((response_r1 & 0xFDFFE008U) == 0x00000000U)
  {
    return 0x00000000U;
  }
  else if((response_r1 & 0x80000000U) == 0x80000000U)
  {
    return 0x02000000U;
  }
  else if((response_r1 & 0x40000000U) == 0x40000000U)
  {
    return 0x00000040U;
  }
  else if((response_r1 & 0x20000000U) == 0x20000000U)
  {
    return 0x00000080U;
  }
  else if((response_r1 & 0x10000000U) == 0x10000000U)
  {
    return 0x00000100U;
  }
  else if((response_r1 & 0x08000000U) == 0x08000000U)
  {
    return 0x00000200U;
  }
  else if((response_r1 & 0x04000000U) == 0x04000000U)
  {
    return 0x00000400U;
  }
  else if((response_r1 & 0x01000000U) == 0x01000000U)
  {
    return 0x00000800U;
  }
  else if((response_r1 & 0x00800000U) == 0x00800000U)
  {
    return 0x00001000U;
  }
  else if((response_r1 & 0x00400000U) == 0x00400000U)
  {
    return 0x00002000U;
  }
  else if((response_r1 & 0x00200000U) == 0x00200000U)
  {
    return 0x00004000U;
  }
  else if((response_r1 & 0x00100000U) == 0x00100000U)
  {
    return 0x00008000U;
  }
  else if((response_r1 & 0x00040000U) == 0x00040000U)
  {
    return 0x00020000U;
  }
  else if((response_r1 & 0x00020000U) == 0x00020000U)
  {
    return 0x00040000U;
  }
  else if((response_r1 & 0x00010000U) == 0x00010000U)
  {
    return 0x00080000U;
  }
  else if((response_r1 & 0x00008000U) == 0x00008000U)
  {
    return 0x00100000U;
  }
  else if((response_r1 & 0x00004000U) == 0x00004000U)
  {
    return 0x00200000U;
  }
  else if((response_r1 & 0x00002000U) == 0x00002000U)
  {
    return 0x00400000U;
  }
  else if((response_r1 & 0x00000008U) == 0x00000008U)
  {
    return 0x00800000U;
  }
  else
...
# 1387 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_sdmmc.c"
static uint32_t SDMMC_GetCmdResp6(SDIO_TypeDef *SDIOx, uint8_t SD_CMD, uint16_t *pRCA)
{
  uint32_t response_r1;
  uint32_t sta_reg;
  ...
  if((response_r1 & (0x00002000U | 0x00004000U | 0x00008000U)) == 0x00000000U)
  {
...
uint32_t SDMMC_CmdSendEXTCSD(SDIO_TypeDef *SDIOx, uint32_t Argument)
{
  ...
  errorstate = SDMMC_GetCmdResp1(SDIOx, 8U,5000U);

# 1 "../Middlewares/FATFS/source/ffsystem.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/FATFS/source/ffsystem.c" 2
...
# 2 "../Middlewares/FATFS/source/ffsystem.c" 2
...
# 4 "../Middlewares/FATFS/source/ffsystem.c" 2
# 14 "../Middlewares/FATFS/source/ffsystem.c"
DWORD get_fattime (void)
{
    return 0;
}

...
int main(void)
{
  ...
  (((0x00000004U) == 0x00000000U) ? ((&tim_handle)->Instance->CCR1 = (dac_value)) : ((0x00000004U) == 0x00000004U) ? ((&tim_handle)->Instance->CCR2 = (dac_value)) : ((0x00000004U) == 0x00000008U) ? ((&tim_handle)->Instance->CCR3 = (dac_value)) : ((&tim_handle)->Instance->CCR4 = (dac_value)));
  while(1)
  {
    i++;
    ...
    if(i == 10||key_value == 4||key_value == 2)
    {

      adc_value = (((0x00000004U) == 0x00000000U) ? ((&tim_handle)->Instance->CCR1) : ((0x00000004U) == 0x00000004U) ? ((&tim_handle)->Instance->CCR2) : ((0x00000004U) == 0x00000008U) ? ((&tim_handle)->Instance->CCR3) : ((&tim_handle)->Instance->CCR4));
      ...
      adc_value = adc_get_result_average(((uint32_t)((0x04UL << (0U)) | (0x01UL << (0U)))), 10);

...
# 125 "../User/SYSTEM/sys\\sys.h"
uint8_t sys_stm32_clock_init(u32 plln,u32 pllm,u32 pllp,u32 pllq);
...
# 5 "../User/SYSTEM/usart\\usart.h" 2
# 34 "../User/SYSTEM/usart\\usart.h"
...
void LCD_Init(void)
{
    ...
    *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(15<<2)))) = 0;
    ...
    *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(15<<2)))) = 1;
...
void LCD_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color)
{
    ...
    {
        ((LCD_TypeDef *) ((u32)(0x6C000000 | 0x0000007E)))->LCD_RAM = color[k];
    }
...
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode)
{
    ...
    for(u16 t_byte_offset = 0; t_byte_offset < csize; t_byte_offset++)
    {
        ...
        for(t1 = 0; t1 < 8; t1++)
        {
            ...
            u16 current_pixel_x = x + (t_byte_offset / (size / 8 + ((size % 8) ? 1 : 0)));

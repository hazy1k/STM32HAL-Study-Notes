...
int main(void)
{
    ...
    while(1)
    {
        switch(test_stage % 4)
        {
            case 0: BACK_COLOR = 0xFFFF; break;
            case 1: BACK_COLOR = 0x07E0; break;
            case 2: BACK_COLOR = 0x001F; break;
            case 3: BACK_COLOR = 0xF800; break;
        }
            ...
            case 1:
                ...
                for (u16 i = 0; i < 50; i++)
                {
                    ...
                    if((i + 10) < lcddev.width && (200 - i) < lcddev.height)
                        LCD_Fast_DrawPoint(i + 10, 200 - i, 0xF800);
                }
                break;
           case 2:
            ...
            case 3:
                ...
                POINT_COLOR = 0x7FFF;
                LCD_Fill(150, 160, 250, 210, 0xFFE0);
                break;
            case 4:

...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/CMSIS/Device/ST/STM32F4xx/Source/Templates/system_stm32f4xx.c" 2
# 49 "../Libraries/CMSIS/Device/ST/STM32F4xx/Source/Templates/system_stm32f4xx.c"
...
# 50 "../Libraries/CMSIS/Device/ST/STM32F4xx/Source/Templates/system_stm32f4xx.c" 2
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      else
      {
        ...
        pllvco = ((16000000U) / pllm) * ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> 6);
      }

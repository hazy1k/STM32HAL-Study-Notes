...
uint8_t send_buff[((sizeof(STRING_TO_SEND)+2)*200)];
...
int main(void)
{
    ...
    dam_uart_init(((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x0B8UL)), 0x08000000U);


    len = sizeof(STRING_TO_SEND) - 1;
    j = 0;
    for(i = 0; i < ((sizeof(STRING_TO_SEND)+2)*200); i++)
    {
        if(j >= len)
        {
            if(mask == 0)
    ...
    while(1)
    {
        ...
        if(key == 1)
        {
            ...
            HAL_UART_Transmit_DMA(&g_uart1_handle, send_buff, ((sizeof(STRING_TO_SEND)+2)*200));


            while(((&dma_handle)->Instance->NDTR) != 0)
            {
                remain = ((&dma_handle)->Instance->NDTR);
                pb = 1.0f - ((float)remain / ((sizeof(STRING_TO_SEND)+2)*200));
                LCD_ShowNum(30,150,(int)(pb*100),3,16);
            }


            (((uint32_t)((&dma_handle)->Instance) > (uint32_t)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x058UL)))? (((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL))->HIFCR = (0x08000000U)) : ((uint32_t)((&dma_handle)->Instance) > (uint32_t)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x0B8UL)))? (((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL))->LIFCR = (0x08000000U)) : ((uint32_t)((&dma_handle)->Instance) > (uint32_t)((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x058UL)))? (((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL))->HIFCR = (0x08000000U)) : (((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6000UL))->LIFCR = (0x08000000U)));

# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c" 2
# 108 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
...
# 109 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c" 2
# 164 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  uint32_t position;
  ...
  for(position = 0U; position < 16U; position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      if(((GPIO_Init->Mode & 0x00000003U) == 0x00000001U) || (GPIO_Init->Mode & 0x00000003U) == 0x00000002U)
      ...
      if((GPIO_Init->Mode & 0x00000003U) == 0x00000002U)
      {
...
# 292 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_DeInit(GPIO_TypeDef *GPIOx, uint32_t GPIO_Pin)
{
  uint32_t position;
  uint32_t ioposition = 0x00U;
...
# 373 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
GPIO_PinState HAL_GPIO_ReadPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 408 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
...
# 431 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_TogglePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
  uint32_t odr;
...
# 456 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
HAL_StatusTypeDef HAL_GPIO_LockPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{

# 1 "../User/SYSTEM/sys/sys.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/SYSTEM/sys/sys.c" 2
...
uint8_t sys_stm32_clock_init(uint32_t plln, uint32_t pllm, uint32_t pllp, uint32_t pllq)
{
    ...
    rcc_osc_init.PLL.PLLState = ((uint8_t)0x02);
    rcc_osc_init.PLL.PLLSource = (0x1UL << (22U));
    ...
    rcc_clk_init.SYSCLKSource = 0x00000002U;
    rcc_clk_init.AHBCLKDivider = 0x00000000U;
    rcc_clk_init.APB1CLKDivider = 0x00001400U;
    rcc_clk_init.APB2CLKDivider = 0x00001000U;
    ret = HAL_RCC_ClockConfig(&rcc_clk_init, 0x00000005U);
    if(ret != HAL_OK)
    {
        return 1;
    }

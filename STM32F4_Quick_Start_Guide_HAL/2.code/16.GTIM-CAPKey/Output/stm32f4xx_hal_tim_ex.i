# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c" 2
# 78 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
...
# 79 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c" 2
# 96 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
static void TIM_DMADelayPulseNCplt(DMA_HandleTypeDef *hdma);
static void TIM_DMAErrorCCxN(DMA_HandleTypeDef *hdma);
static void TIM_CCxNChannelCmd(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t ChannelNState);
# 135 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_HallSensor_Init(TIM_HandleTypeDef *htim, TIM_HallSensor_InitTypeDef *sConfig)
{
...
# 171 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
...
# 255 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
...
# 479 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_HallSensor_Start_DMA(TIM_HandleTypeDef *htim, uint32_t *pData, uint16_t Length)
{
  uint32_t tmpsmcr;
  HAL_TIM_ChannelStateTypeDef channel_1_state = (((0x00000000U) == 0x00000000U) ? (htim)->ChannelState[0] : ((0x00000000U) == 0x00000004U) ? (htim)->ChannelState[1] : ((0x00000000U) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]);
...
# 615 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 666 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 698 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 780 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpccer;
...
# 849 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData, uint16_t Length)
{
  uint32_t tmpsmcr;
...
# 978 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop_DMA(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 1073 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_PWMN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 1123 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_PWMN_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 1155 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_PWMN_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 1236 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_PWMN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpccer;
...
# 1306 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_PWMN_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData, uint16_t Length)
{
  uint32_t tmpsmcr;
...
# 1435 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_PWMN_Stop_DMA(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 1520 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Start(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
...
# 1569 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Stop(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  uint32_t input_channel = (OutputChannel == 0x00000000U) ? 0x00000004U : 0x00000000U;
...
# 1608 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Start_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  uint32_t input_channel = (OutputChannel == 0x00000000U) ? 0x00000004U : 0x00000000U;
  HAL_TIM_ChannelStateTypeDef channel_1_state = (((0x00000000U) == 0x00000000U) ? (htim)->ChannelState[0] : ((0x00000000U) == 0x00000004U) ? (htim)->ChannelState[1] : ((0x00000000U) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]);
...
# 1663 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  uint32_t input_channel = (OutputChannel == 0x00000000U) ? 0x00000004U : 0x00000000U;
...
# 1742 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_ConfigCommutEvent(TIM_HandleTypeDef *htim, uint32_t InputTrigger,
                                              uint32_t CommutationSource)
{
...
# 1798 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_ConfigCommutEvent_IT(TIM_HandleTypeDef *htim, uint32_t InputTrigger,
                                                 uint32_t CommutationSource)
{
...
# 1855 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_ConfigCommutEvent_DMA(TIM_HandleTypeDef *htim, uint32_t InputTrigger,
                                                  uint32_t CommutationSource)
{
...
# 1904 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_MasterConfigSynchronization(TIM_HandleTypeDef *htim,
                                                        TIM_MasterConfigTypeDef *sMasterConfig)
{
  uint32_t tmpcr2;
...
# 1965 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakDeadTime(TIM_HandleTypeDef *htim,
                                                TIM_BreakDeadTimeConfigTypeDef *sBreakDeadTimeConfig)
{
...
# 2041 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_StatusTypeDef HAL_TIMEx_RemapConfig(TIM_HandleTypeDef *htim, uint32_t Remap)
{
  do{ if((htim)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (htim)->Lock = HAL_LOCKED; } }while (0U);
  ...
  ((void)0U);
# 2064 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
...
# 2097 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
...
# 2159 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_TIM_StateTypeDef HAL_TIMEx_HallSensor_GetState(TIM_HandleTypeDef *htim)
{
  return htim->State;
}
# 2174 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
HAL_TIM_ChannelStateTypeDef HAL_TIMEx_GetChannelNState(TIM_HandleTypeDef *htim, uint32_t ChannelN)
{
...
# 2203 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
void TIMEx_DMACommutationCplt(DMA_HandleTypeDef *hdma)
{
...
# 2346 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c"
static void TIM_CCxNChannelCmd(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t ChannelNState)
{
  uint32_t tmp;

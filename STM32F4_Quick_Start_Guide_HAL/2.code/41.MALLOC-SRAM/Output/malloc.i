# 1 "../Middlewares/malloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/malloc.c" 2
...
# 2 "../Middlewares/malloc.c" 2
# 15 "../Middlewares/malloc.c"
static __attribute__((aligned(64))) uint8_t mem1base[100 * 1024];
static __attribute__((aligned(64))) uint8_t mem2base[60 * 1024] __attribute__((section(".bss.ARM.__at_0x10000000")));
static __attribute__((aligned(64))) uint8_t mem3base[963 * 1024] __attribute__((section(".bss.ARM.__at_0x68000000")));

static uint16_t mem1mapbase[100 * 1024/32];
static uint16_t mem2mapbase[60 * 1024/32] __attribute__((section(".bss.ARM.__at_0x1000F000")));
static uint16_t mem3mapbase[963 * 1024/32] __attribute__((section(".bss.ARM.__at_0x680F0C00")));


const uint32_t memtblsize[3] = {100 * 1024/32, 60 * 1024/32, 963 * 1024/32};
const uint32_t memblksize[3] = {32, 32, 32};
const uint32_t memsize[3] = {100 * 1024, 60 * 1024, 963 * 1024};
...
void my_mem_init(uint8_t memx)
{
    uint8_t mttsize = sizeof(uint16_t);

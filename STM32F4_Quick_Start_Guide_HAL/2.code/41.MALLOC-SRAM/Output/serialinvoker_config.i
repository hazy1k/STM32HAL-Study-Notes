# 1 "../Middlewares/SerialInvoker_config.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/SerialInvoker_config.c" 2
...
# 53 "E:\\dianzi\\MDKv5\\ARM\\ARMCLANG\\Bin\\..\\include\\stdio.h" 3
...
# 5 "../Middlewares/SerialInvoker.h" 2
...
# 2 "../Middlewares/SerialInvoker_config.c" 2
...
void delay_us(uint32_t nus);
    ...
    void HAL_Delay(uint32_t Delay);
# 8 "../Middlewares/SerialInvoker_config.c" 2
...
# 9 "../Middlewares/SerialInvoker_config.c" 2
...
# 10 "../Middlewares/SerialInvoker_config.c" 2

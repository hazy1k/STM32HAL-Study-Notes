# 1 "../Middlewares/USMART/usmart_port.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/USMART/usmart_port.c" 2
...
# 2 "../Middlewares/USMART/usmart_port.c" 2


TIM_HandleTypeDef g_timx_usmart_handle;
# 14 "../Middlewares/USMART/usmart_port.c"
char *usmart_get_input_string(void)
{
    uint8_t len;
    char *pbuf = 0;
...
# 47 "../Middlewares/USMART/usmart_port.c"
void usmart_timx_reset_time(void)
{
    ((&g_timx_usmart_handle)->Instance->SR = ~((0x1UL << (0U))));
    do{ (&g_timx_usmart_handle)->Instance->ARR = (0XFFFF); (&g_timx_usmart_handle)->Init.Period = (0XFFFF); } while(0);
    ((&g_timx_usmart_handle)->Instance->CNT = (0));
...
uint32_t usmart_timx_get_time(void)
{
    if ((((&g_timx_usmart_handle)->Instance->SR &((0x1UL << (0U)))) == ((0x1UL << (0U)))) == SET)
    {
        usmart_dev.runtime += 0XFFFF;
    }
    usmart_dev.runtime += ((&g_timx_usmart_handle)->Instance->CNT);
...
void usmart_timx_init(uint16_t arr, uint16_t psc)
{
    ...
    g_timx_usmart_handle.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x0800UL));
    g_timx_usmart_handle.Init.Prescaler = psc;
    g_timx_usmart_handle.Init.CounterMode = 0x00000000U;
    g_timx_usmart_handle.Init.Period = arr;
    g_timx_usmart_handle.Init.ClockDivision = 0x00000000U;
...
{
    if(((((&g_timx_usmart_handle)->Instance->DIER & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) ? SET : RESET)==SET)
    {
        usmart_dev.scan();
        ((&g_timx_usmart_handle)->Instance->CNT = (0));;
        do{ (&g_timx_usmart_handle)->Instance->ARR = (100); (&g_timx_usmart_handle)->Init.Period = (100); } while(0);
    }

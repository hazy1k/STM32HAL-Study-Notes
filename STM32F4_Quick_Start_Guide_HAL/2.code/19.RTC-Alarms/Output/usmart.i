# 1 "../Middlewares/USMART/usmart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/USMART/usmart.c" 2
...
# 2 "../Middlewares/USMART/usmart.c" 2
...
# 3 "../Middlewares/USMART/usmart.c" 2
    ...
    switch (i)
    {
        ...
        case 3:
            ...
            for (i = 0; i < usmart_dev.fnum; i++)
            {
                ...
                printf("%s id is:\r\n0X%08X\r\n", sfname, (unsigned int)usmart_dev.funs[i].func);
            }
...
# 258 "../Middlewares/USMART/usmart.c"
void usmart_exe(void)
{
    uint8_t id, i;
    uint32_t res;
...
# 383 "../Middlewares/USMART/usmart.c"
void usmart_scan(void)
{
    uint8_t sta, len;
    char *pbuf = 0;
...
# 435 "../Middlewares/USMART/usmart.c"
uint32_t read_addr(uint32_t addr)
{

...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c" 2
# 213 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
...
# 214 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c" 2
# 274 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_Init(CAN_HandleTypeDef *hcan)
{
  uint32_t tickstart;
...
# 459 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_DeInit(CAN_HandleTypeDef *hcan)
{
...
# 484 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
...
# 838 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_ConfigFilter(CAN_HandleTypeDef *hcan, CAN_FilterTypeDef *sFilterConfig)
{
...
# 892 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
    ((can_ip->FMR) |= ((0x1UL << (0U))));
# 905 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
...
# 1032 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_Start(CAN_HandleTypeDef *hcan)
{
  uint32_t tickstart;
...
# 1139 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_RequestSleep(CAN_HandleTypeDef *hcan)
{
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 1170 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_WakeUp(CAN_HandleTypeDef *hcan)
{
...
# 1219 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
uint32_t HAL_CAN_IsSleepActive(CAN_HandleTypeDef *hcan)
{
  uint32_t status = 0U;
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 1250 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_AddTxMessage(CAN_HandleTypeDef *hcan, CAN_TxHeaderTypeDef *pHeader, uint8_t aData[], uint32_t *pTxMailbox)
{
...
# 1358 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_AbortTxRequest(CAN_HandleTypeDef *hcan, uint32_t TxMailboxes)
{
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 1450 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
uint32_t HAL_CAN_IsTxMessagePending(CAN_HandleTypeDef *hcan, uint32_t TxMailboxes)
{
  uint32_t status = 0U;
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 1482 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
uint32_t HAL_CAN_GetTxTimestamp(CAN_HandleTypeDef *hcan, uint32_t TxMailbox)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    transmitmailbox = ((uint8_t)__builtin_clz(__builtin_arm_rbit(TxMailbox)));
...
# 1516 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_GetRxMessage(CAN_HandleTypeDef *hcan, uint32_t RxFifo, CAN_RxHeaderTypeDef *pHeader, uint8_t aData[])
{
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 1606 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
uint32_t HAL_CAN_GetRxFifoFillLevel(CAN_HandleTypeDef *hcan, uint32_t RxFifo)
{
...
# 1659 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_ActivateNotification(CAN_HandleTypeDef *hcan, uint32_t ActiveITs)
{
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 1692 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_StatusTypeDef HAL_CAN_DeactivateNotification(CAN_HandleTypeDef *hcan, uint32_t InactiveITs)
{
  HAL_CAN_StateTypeDef state = hcan->State;
...
# 2134 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
...
# 2374 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_can.c"
HAL_CAN_StateTypeDef HAL_CAN_GetState(CAN_HandleTypeDef *hcan)
{
  HAL_CAN_StateTypeDef state = hcan->State;

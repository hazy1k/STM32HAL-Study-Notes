...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_wwdg.c" 2
...
# 130 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_wwdg.c" 2
...
__attribute__((weak)) void HAL_WWDG_MspInit(WWDG_HandleTypeDef *hwwdg)
{
...
# 366 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_wwdg.c"
void HAL_WWDG_IRQHandler(WWDG_HandleTypeDef *hwwdg)
{
...
__attribute__((weak)) void HAL_WWDG_EarlyWakeupCallback(WWDG_HandleTypeDef *hwwdg)
{

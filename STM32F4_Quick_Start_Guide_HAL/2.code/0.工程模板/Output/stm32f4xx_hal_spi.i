# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c" 2
# 202 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 203 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c" 2
# 231 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 313 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Init(SPI_HandleTypeDef *hspi)
{
...
# 388 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 411 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
HAL_StatusTypeDef HAL_SPI_DeInit(SPI_HandleTypeDef *hspi)
{
  ...
  (((hspi)->Instance->CR1) &= ~((0x1UL << (6U))));
# 465 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 771 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Transmit(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart;
...
# 936 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Receive(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
...
# 1134 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_TransmitReceive(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size,
                                          uint32_t Timeout)
{
...
# 1358 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Transmit_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef errorcode = HAL_OK;
...
# 1443 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Receive_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef errorcode = HAL_OK;
...
# 1537 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 1625 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Transmit_DMA(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef errorcode = HAL_OK;
...
# 1733 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Receive_DMA(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef errorcode = HAL_OK;
...
# 1848 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_TransmitReceive_DMA(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData,
                                              uint16_t Size)
{
  uint32_t tmp_mode;
...
# 1994 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Abort(SPI_HandleTypeDef *hspi)
{
...
# 2139 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Abort_IT(SPI_HandleTypeDef *hspi)
{
  HAL_StatusTypeDef errorcode;
  uint32_t abortcplt ;
...
# 2636 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_SPI_StateTypeDef HAL_SPI_GetState(SPI_HandleTypeDef *hspi)
{
...
# 2673 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
...
# 2998 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  SPI_HandleTypeDef *hspi = (SPI_HandleTypeDef *)(((DMA_HandleTypeDef *)hdma)->Parent);
  volatile uint32_t count;
...
# 3063 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  SPI_HandleTypeDef *hspi = (SPI_HandleTypeDef *)(((DMA_HandleTypeDef *)hdma)->Parent);
...
# 3157 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_2linesRxISR_8BITCRC(struct __SPI_HandleTypeDef *hspi)
{
  volatile uint32_t tmpreg = 0U;
...
# 3182 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_2linesTxISR_8BIT(struct __SPI_HandleTypeDef *hspi)
{
  *(volatile uint8_t *)&hspi->Instance->DR = (*hspi->pTxBuffPtr);
  hspi->pTxBuffPtr++;
...
# 3252 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_2linesRxISR_16BITCRC(struct __SPI_HandleTypeDef *hspi)
{
  volatile uint32_t tmpreg = 0U;
...
# 3274 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_2linesTxISR_16BIT(struct __SPI_HandleTypeDef *hspi)
{
...
# 3312 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_RxISR_8BITCRC(struct __SPI_HandleTypeDef *hspi)
{
  volatile uint32_t tmpreg = 0U;
...
# 3331 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_RxISR_8BIT(struct __SPI_HandleTypeDef *hspi)
{
  *hspi->pRxBuffPtr = (*(volatile uint8_t *)&hspi->Instance->DR);
  hspi->pRxBuffPtr++;
...
# 3365 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_RxISR_16BITCRC(struct __SPI_HandleTypeDef *hspi)
{
  volatile uint32_t tmpreg = 0U;
...
# 3387 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_RxISR_16BIT(struct __SPI_HandleTypeDef *hspi)
{
  *((uint16_t *)hspi->pRxBuffPtr) = (uint16_t)(hspi->Instance->DR);
  hspi->pRxBuffPtr += sizeof(uint16_t);
...
# 3475 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static HAL_StatusTypeDef SPI_WaitFlagStateUntilTimeout(SPI_HandleTypeDef *hspi, uint32_t Flag, FlagStatus State,
                                                       uint32_t Timeout, uint32_t Tickstart)
{
  volatile uint32_t count;
...
# 3542 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static HAL_StatusTypeDef SPI_EndRxTransaction(SPI_HandleTypeDef *hspi, uint32_t Timeout, uint32_t Tickstart)
{
  if ((hspi->Init.Mode == ((0x1UL << (2U)) | (0x1UL << (8U)))) && ((hspi->Init.Direction == (0x1UL << (15U)))
                                               || (hspi->Init.Direction == (0x1UL << (10U)))))
...
# 3592 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static HAL_StatusTypeDef SPI_EndRxTxTransaction(SPI_HandleTypeDef *hspi, uint32_t Timeout, uint32_t Tickstart)
{

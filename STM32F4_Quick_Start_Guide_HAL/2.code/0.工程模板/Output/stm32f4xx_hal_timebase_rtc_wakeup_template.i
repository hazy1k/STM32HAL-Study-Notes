# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c" 2
# 48 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
...
# 49 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c" 2
# 82 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
RTC_HandleTypeDef hRTC_Handle;


void RTC_WKUP_IRQHandler(void);
# 102 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
HAL_StatusTypeDef HAL_InitTick (uint32_t TickPriority)
{
...
# 124 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
...
# 155 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
  ...
  if (status == HAL_OK)
  {
    ...
    ((&hRTC_Handle)->Instance->CR &= ~((0x1UL << (10U))));


    ((&hRTC_Handle)->Instance->CR &= ~(0x00004000U));


    while ((((((&hRTC_Handle)->Instance->ISR) & (0x00000004U)) != RESET)? SET : RESET) == RESET)
    {
  ...
  if (status == HAL_OK)
  {
    ...
    (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR |= ((0x1UL << (0U))) << 2U);


    ((&hRTC_Handle)->Instance->ISR) = (~((0x00000400U) | (0x1UL << (7U)))|((&hRTC_Handle)->Instance->ISR & (0x1UL << (7U))));


    hRTC_Handle.Instance->WUTR = 0U;


    hRTC_Handle.Instance->CR &= (uint32_t)~(0x7UL << (0U));


    hRTC_Handle.Instance->CR |= (uint32_t)0x00000004U;
...
# 270 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_wakeup_template.c"
void HAL_RTCEx_WakeUpTimerEventCallback(RTC_HandleTypeDef *hrtc)
{
  HAL_IncTick();
}

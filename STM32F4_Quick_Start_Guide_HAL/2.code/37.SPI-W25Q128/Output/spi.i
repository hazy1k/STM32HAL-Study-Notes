# 1 "../User/BSP/spi/spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/spi/spi.c" 2
...
# 5 "../User/BSP/spi/spi.h" 2
# 16 "../User/BSP/spi/spi.h"
void spi_init(void);
void spi1_set_speed(uint8_t speed);
uint8_t spi1_read_write_byte(uint8_t txdata);
# 2 "../User/BSP/spi/spi.c" 2
...
void spi_init(void)
{
    ...
    spi_handle.Instance = ((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL));
    spi_handle.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
    spi_handle.Init.Direction = (0x00000000U);
    spi_handle.Init.DataSize = (0x00000000U);
    spi_handle.Init.CLKPolarity = (0x1UL << (1U));
    spi_handle.Init.CLKPhase = (0x1UL << (0U));
    spi_handle.Init.NSS = (0x1UL << (9U));
    spi_handle.Init.BaudRatePrescaler = ((0x4UL << (3U)) | (0x2UL << (3U)) | (0x1UL << (3U)));
    spi_handle.Init.TIMode = (0x00000000U);
    spi_handle.Init.CRCCalculation = (0x00000000U);
    spi_handle.Init.CRCPolynomial = 7;
    (((&spi_handle)->Instance->CR1) |= ((0x1UL << (6U))));
...
# 53 "../User/BSP/spi/spi.c"
void spi1_set_speed(uint8_t speed)
{
    ((void)0U);
    (((&spi_handle)->Instance->CR1) &= ~((0x1UL << (6U))));
    spi_handle.Instance->CR1 &= 0XFFC7;
    spi_handle.Instance->CR1 |= speed << 3;
    (((&spi_handle)->Instance->CR1) |= ((0x1UL << (6U))));
}

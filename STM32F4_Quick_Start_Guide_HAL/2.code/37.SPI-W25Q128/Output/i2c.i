# 1 "../User/BSP/i2c/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/i2c/i2c.c" 2
...
void i2c_start(void)
{
    do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_RESET); }while(0);
    do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
    i2c_delay();
    do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_RESET); }while(0);
    i2c_delay();
    do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
    i2c_delay();
}
...
uint8_t i2c_wait_ack(void)
{
    ...
    do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
    i2c_delay();
    while(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200)))
    {
        wait_time++;
        if(wait_time > 250)
        {
...
void i2c_send_byte(uint8_t data)
{
    ...
    for(i=0;i<8;i++)
    {
        do{ (data&0x80)>>7 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_RESET); }while(0);
        i2c_delay();
        do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
        i2c_delay();
        do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
...
uint8_t i2c_read_byte(uint8_t ack)
{
    ...
    for(i=0;i<8;i++)
    {
        ...
        do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
        i2c_delay();
        if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200)))
        {
            reve++;
        }
        do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); }while(0);
...
void i2c_init(void)
{
    ...
    GPIO_InitStructure.Mode = (0x00000000U | 0x00000001U);
    ...
    GPIO_InitStructure.Mode = (0x00000010U | 0x00000001U);
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), &GPIO_InitStructure);
    i2c_stop();
}

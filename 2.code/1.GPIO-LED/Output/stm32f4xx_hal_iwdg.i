...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_iwdg.c" 2
...
# 99 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_iwdg.c" 2
# 162 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_iwdg.c"
HAL_StatusTypeDef HAL_IWDG_Init(IWDG_HandleTypeDef *hiwdg)
{
  uint32_t tickstart;
  ...
  while ((hiwdg->Instance->SR & ((0x1UL << (1U)) | (0x1UL << (0U)))) != 0x00u)
  {
    if ((HAL_GetTick() - tickstart) > ((6UL * 256UL * 1000UL) / (32000U)))
    {
      if ((hiwdg->Instance->SR & ((0x1UL << (1U)) | (0x1UL << (0U)))) != 0x00u)
      {
        return HAL_TIMEOUT;
      }
    }
...
# 236 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_iwdg.c"
HAL_StatusTypeDef HAL_IWDG_Refresh(IWDG_HandleTypeDef *hiwdg)
{

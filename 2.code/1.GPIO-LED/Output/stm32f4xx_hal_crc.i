# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c" 2
# 46 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c"
...
# 47 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c" 2
# 95 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c"
HAL_StatusTypeDef HAL_CRC_Init(CRC_HandleTypeDef *hcrc)
{
...
# 227 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c"
uint32_t HAL_CRC_Accumulate(CRC_HandleTypeDef *hcrc, uint32_t pBuffer[], uint32_t BufferLength)
{
  uint32_t index;
  uint32_t temp = 0U;
...
# 257 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c"
uint32_t HAL_CRC_Calculate(CRC_HandleTypeDef *hcrc, uint32_t pBuffer[], uint32_t BufferLength)
{
  uint32_t index;
  uint32_t temp = 0U;
...
# 306 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_crc.c"
HAL_CRC_StateTypeDef HAL_CRC_GetState(CRC_HandleTypeDef *hcrc)
{

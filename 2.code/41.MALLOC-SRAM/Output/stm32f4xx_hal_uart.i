...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c" 2
# 257 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
# 258 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c" 2
...
# 396 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
# 432 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_HalfDuplex_Init(UART_HandleTypeDef *huart)
{
...
HAL_StatusTypeDef HAL_LIN_Init(UART_HandleTypeDef *huart, uint32_t BreakDetectLength)
{
  ...
  if (huart->gState == HAL_UART_STATE_RESET)
  {
    ...
    huart->Lock = HAL_UNLOCKED;
# 538 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
    HAL_UART_MspInit(huart);
...
# 586 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_MultiProcessor_Init(UART_HandleTypeDef *huart, uint8_t Address, uint32_t WakeUpMethod)
{
...
# 1133 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Transmit(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint8_t *pdata8bits;
...
# 1392 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Transmit_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  uint32_t *tmp;
...
# 1460 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Receive_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
...
# 1618 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint16_t *RxLen, uint32_t Timeout)
{
  uint8_t *pdata8bits;
  uint16_t *pdata16bits;
...
# 1744 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
...
# 1805 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef status;
...
# 1862 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Abort(UART_HandleTypeDef *huart)
{
...
# 1951 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_AbortTransmit(UART_HandleTypeDef *huart)
{
...
# 2002 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_AbortReceive(UART_HandleTypeDef *huart)
{
...
# 2063 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Abort_IT(UART_HandleTypeDef *huart)
{
...
# 2704 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
# 2744 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef HAL_LIN_SendBreak(UART_HandleTypeDef *huart)
{
...
# 2917 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_UART_StateTypeDef HAL_UART_GetState(UART_HandleTypeDef *huart)
{
...
# 2977 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static void UART_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
...
# 3164 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static HAL_StatusTypeDef UART_WaitOnFlagUntilTimeout(UART_HandleTypeDef *huart, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
{
...
# 3202 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef UART_Start_Receive_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
...
# 3237 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
HAL_StatusTypeDef UART_Start_Receive_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  uint32_t *tmp;
...
# 3325 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static void UART_DMAAbortOnError(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
  huart->RxXferCount = 0x00U;
...
# 3349 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static void UART_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 3395 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static void UART_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 3441 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static void UART_DMATxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 3469 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
static void UART_DMARxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 3671 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
# 3687 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"

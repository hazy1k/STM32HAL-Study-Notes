...
const char *SRAM_NAME_BUF[3] = {" SRAMIN  ", " SRAMCCM ", " SRAMEX  "};
 ...
 serial_invoker_init(84);
  ...
  while(1)
  {
    ...
    if(tp != p)
    {
      ...
      {
        LCD_Fill(30,260,280,200,0xFFFF);
      }
    }
    delay_ms(10);
    i++;

# 1 "../User/BSP/rtc/rtc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/rtc/rtc.c" 2
# 1 "../User/BSP/rtc/rtc.h" 1
...
{
    uint32_t temp = 0;
    temp = HAL_RTCEx_BKUPRead(&rtc_handle, bkrx);
    return temp;
}

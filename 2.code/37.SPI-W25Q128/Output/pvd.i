# 1 "../User/BSP/pvd/pvd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/pvd/pvd.c" 2
...
void HAL_PWR_PVDCallback(void)
{
    if(((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR & ((0x1UL << (2U)))) == ((0x1UL << (2U)))))
    {

# 1 "../User/BSP/flash/flash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/flash/flash.c" 2
...
# 4 "../User/BSP/flash/flash.c" 2
# 1 "../User/BSP/spi\\spi.h" 1
# 16 "../User/BSP/spi\\spi.h"
void spi_init(void);
void spi1_set_speed(uint8_t speed);
uint8_t spi1_read_write_byte(uint8_t txdata);
# 5 "../User/BSP/flash/flash.c" 2

uint16_t myflash_type = 0XEF17;
...
void flash_write_enable(void)
{
    do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_RESET); }while(0);
    spi1_read_write_byte(0x06);
    do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_RESET); }while(0);
}
...
# 123 "../User/BSP/flash/flash.c"
uint16_t flash_read_id(void)
{
    uint16_t deviceid;
    do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_RESET); }while(0);
    spi1_read_write_byte(0x9F);
...
void flash_write(uint8_t *pbuf, uint32_t addr, uint16_t datalen)
{
    ...
    while (1)
    {
        ...
        if (i < secremain)
        {
            ...
            flash_write_nocheck(norflash_buf, secpos * 4096, 4096);
        }
        else
        {
...
void flash_erase_chip(void)
{
    ...
    flash_wait_busy();
    do{ 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_RESET); }while(0);
    spi1_read_write_byte(0xC7);
    do{ 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_RESET); }while(0);
    flash_wait_busy();
}
# 318 "../User/BSP/flash/flash.c"
void flash_erase_sector(uint32_t saddr)
{

# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c" 2
# 47 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
...
# 48 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c" 2
# 99 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_DualStart(DAC_HandleTypeDef *hdac)
{
  ...
  ((hdac)->Instance->CR |= ((0x1UL << (0U)) << ((0x00000000U) & 0x10UL)));
  ((hdac)->Instance->CR |= ((0x1UL << (0U)) << ((0x00000010U) & 0x10UL)));
  ...
  if ((hdac->Instance->CR & ((0x1UL << (18U)) | (0x7UL << (19U)))) == (((0x7UL << (3U)) | (0x1UL << (2U))) << (0x00000010U & 0x10UL)))
  {
    tmp_swtrig |= (0x1UL << (1U));
  }

  ((hdac->Instance->SWTRIGR) |= (tmp_swtrig));
...
# 182 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_TriangleWaveGenerate(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Amplitude)
{
  ...
  (((hdac->Instance->CR)) = ((((((hdac->Instance->CR))) & (~((((0x3UL << (6U))) | ((0xFUL << (8U)))) << (Channel & 0x10UL)))) | (((0x2UL << (6U)) | Amplitude) << (Channel & 0x10UL)))));
...
# 232 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_NoiseWaveGenerate(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Amplitude)
{
  ...
  (((hdac->Instance->CR)) = ((((((hdac->Instance->CR))) & (~((((0x3UL << (6U))) | ((0xFUL << (8U)))) << (Channel & 0x10UL)))) | (((0x1UL << (6U)) | Amplitude) << (Channel & 0x10UL)))));
...
# 274 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_DualSetValue(DAC_HandleTypeDef *hdac, uint32_t Alignment, uint32_t Data1, uint32_t Data2)
{
  uint32_t data;
  uint32_t tmp;
...
# 395 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
uint32_t HAL_DACEx_DualGetValue(DAC_HandleTypeDef *hdac)
{
  uint32_t tmp = 0UL;
...
# 428 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac_ex.c"
void DAC_DMAConvCpltCh2(DMA_HandleTypeDef *hdma)
{

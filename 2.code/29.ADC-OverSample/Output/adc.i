...
DMA_HandleTypeDef dma_handle;
uint8_t adc_dma_sta = 0;

void adc_init(void)
{
    adc_handle.Instance = ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL));
    adc_handle.Init.ClockPrescaler = ((uint32_t)(0x1UL << (16U)));
    adc_handle.Init.Resolution = 0x00000000U;
    adc_handle.Init.DataAlign = 0x00000000U;
    adc_handle.Init.ScanConvMode = DISABLE;
    adc_handle.Init.ContinuousConvMode = DISABLE;
    adc_handle.Init.NbrOfConversion = 1;
    adc_handle.Init.DiscontinuousConvMode = DISABLE;
    adc_handle.Init.ExternalTrigConv = ((uint32_t)(0xFUL << (24U)) + 1U);
    adc_handle.Init.ExternalTrigConvEdge = 0x00000000U;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
    if(hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL)))
    {
        ...
        GPIO_Initure.Pin = ((uint16_t)0x0020);
        GPIO_Initure.Mode = 0x00000003U;
        GPIO_Initure.Pull = 0x00000000U;
        HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), &GPIO_Initure);

        HAL_NVIC_SetPriority(DMA2_Stream4_IRQn, 2, 2);
        HAL_NVIC_EnableIRQ(DMA2_Stream4_IRQn);
    }
}
# 55 "../User/BSP/adc/adc.c"
void adc_channel_set(ADC_HandleTypeDef *adc_handle, uint32_t ch, uint32_t rank, uint32_t stime)
{
...
uint32_t adc_get_result(uint32_t ch)
{
    ...
    s_config.Channel = ch;
    s_config.Rank = 1;
    s_config.SamplingTime = ((uint32_t)(0x7UL << (0U)));
...
void adc_dma_init(uint32_t address)
{
    ...
    dma_handle.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x070UL));
    dma_handle.Init.Channel = 0x00000000U;
    dma_handle.Init.Direction = 0x00000000U;
    dma_handle.Init.PeriphInc = 0x00000000U;
    dma_handle.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    dma_handle.Init.PeriphDataAlignment = ((uint32_t)(0x1UL << (11U)));
    dma_handle.Init.MemDataAlignment = ((uint32_t)(0x1UL << (13U)));
    dma_handle.Init.Mode = ((uint32_t)(0x1UL << (8U)));
    dma_handle.Init.Priority = ((uint32_t)(0x1UL << (16U)));
    dma_handle.Init.FIFOMode = 0x00000000U;
    dma_handle.Init.FIFOThreshold = ((uint32_t)(0x3UL << (0U)));
    dma_handle.Init.MemBurst = 0x00000000U;
    dma_handle.Init.PeriphBurst = 0x00000000U;
    ...
    do{ (&adc_handle)->DMA_Handle = &(dma_handle); (dma_handle).Parent = (&adc_handle); } while(0U);


    adc_channel_set(&adc_handle, ((uint32_t)((0x04UL << (0U)) | (0x01UL << (0U)))), 1, ((uint32_t)((0x2UL << (0U)) | (0x1UL << (0U)))));


    ((adc_handle.Instance->CR2) |= ((0x1UL << (1U))));



    if (HAL_ADC_Start_DMA(&adc_handle, (uint32_t*)address, 2560) != HAL_OK)
    {
    ...
    (((((uint32_t)(0x1UL << (4U)))) != 0x00000080U)? ((&dma_handle)->Instance->CR |= (((uint32_t)(0x1UL << (4U))))) : ((&dma_handle)->Instance->FCR |= (((uint32_t)(0x1UL << (4U))))));
}
...
void adc_dma_enable(uint16_t times)
{
    ...
    ((&adc_handle)->Instance->CR2 &= ~(0x1UL << (0U)));
    ((&dma_handle)->Instance->CR &= ~(0x1UL << (0U)));
    ...
    ((adc_handle.Instance->CR2) |= ((0x1UL << (30U))));
}

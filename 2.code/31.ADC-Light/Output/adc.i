...
void adc_init(void)
{
    ...
    adc_handle.Instance = ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL));
...
void light_sensor_init(void)
{
    ...
    gpio_init_structure.Mode = 0x00000003U;
    gpio_init_structure.Pull = 0x00000000U;
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), &gpio_init_structure);
    adc_init();
}
...
{
    uint32_t temp_val = 0;
    temp_val = adc_get_result_average(((uint32_t)((0x04UL << (0U)) | (0x01UL << (0U)))), 10);
    temp_val /= 40;
    if(temp_val > 100)
    {
        temp_val = 100;

# 1 "../Middlewares/FATFS/exfuns/fattester.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 2 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 3 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 4 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 5 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 6 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 7 "../Middlewares/FATFS/exfuns/fattester.c" 2
...
# 26 "../Middlewares/FATFS/exfuns/fattester.c"
uint8_t mf_init(void)
{
    fattester.file = (FIL *)mymalloc(0, sizeof(FIL));
    fattester.fatbuf = (uint8_t *)mymalloc(0, 512);
...
uint32_t mf_size(void)
{
    return ((fattester.file)->obj.objsize);
}
...
# 342 "../Middlewares/FATFS/exfuns/fattester.c"
uint8_t mf_fmkfs(uint8_t *path, uint8_t opt, uint16_t au)
{
    MKFS_PARM temp = {0x07, 0, 0, 0, 0};
    temp.fmt = opt;
    temp.au_size = au;
    return f_mkfs((const TCHAR *)path, &temp, 0, 512);
}

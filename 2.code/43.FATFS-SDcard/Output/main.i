...
# 1 "../User/BSP/spi\\spi.h" 1
# 16 "../User/BSP/spi\\spi.h"
void spi_init(void);
void spi1_set_speed(uint8_t speed);
uint8_t spi1_read_write_byte(uint8_t txdata);
# 14 "../User/BSP\\bsp_init.h" 2
# 1 "../User/BSP/flash\\flash.h" 1
# 47 "../User/BSP/flash\\flash.h"
extern uint16_t myflash_type;
# 56 "../User/BSP/flash\\flash.h"
...
# 19 "../User/BSP\\bsp_init.h" 2

void bsp_init(void);
# 2 "../User/main.c" 2
# 1 "../Middlewares/FATFS/exfuns\\exfuns.h" 1
...
# 49 "../Middlewares/FATFS/source\\ff.h"
...
# 6 "../Middlewares/FATFS/exfuns\\exfuns.h" 2
...
# 46 "../Middlewares/FATFS/exfuns\\exfuns.h"
...
int main(void)
{
  ...
  while(exfuns_get_free("0",&total,&free))
  {

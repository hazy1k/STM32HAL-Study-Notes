# 1 "../Middlewares/FATFS/source/diskio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/FATFS/source/diskio.c" 2
...
# 2 "../Middlewares/FATFS/source/diskio.c" 2
...
# 3 "../Middlewares/FATFS/source/diskio.c" 2
...
# 9 "../Middlewares/FATFS/source/diskio.h" 2
...
# 4 "../Middlewares/FATFS/source/diskio.c" 2
...
# 5 "../Middlewares/FATFS/source/diskio.c" 2
...
# 6 "../Middlewares/FATFS/source/diskio.c" 2
# 25 "../Middlewares/FATFS/source/diskio.c"
DSTATUS disk_status (
    BYTE pdrv
)
{
...
# 76 "../Middlewares/FATFS/source/diskio.c"
DRESULT disk_read (
    BYTE pdrv,
    BYTE *buff,
    DWORD sector,
...
)
{
    ...
    switch (pdrv)
    {
        ...
        case 1:
            for (; count > 0; count--)
            {
                flash_read(buff, 0 + sector * 512, 512);
                sector++;
                buff += 512;
            }
...
# 135 "../Middlewares/FATFS/source/diskio.c"
DRESULT disk_write (
    BYTE pdrv,
    const BYTE *buff,
    DWORD sector,
...
)
{
    ...
    switch (pdrv)
    {
        ...
        case 1:
            for (; count > 0; count--)
            {
                flash_write((uint8_t *)buff, 0 + sector * 512, 512);
                sector++;
                buff += 512;
            }
...
# 193 "../Middlewares/FATFS/source/diskio.c"
DRESULT disk_ioctl (
    BYTE pdrv,
    BYTE cmd,
    void *buff

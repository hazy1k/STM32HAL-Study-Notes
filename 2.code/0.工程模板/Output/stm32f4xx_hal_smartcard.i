# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c" 2
# 176 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
...
# 177 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c" 2
# 205 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
...
# 299 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Init(SMARTCARD_HandleTypeDef *hsc)
{
...
# 328 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
  ...
  (((hsc->Instance->GTPR)) = ((((((hsc->Instance->GTPR))) & (~((0xFFUL << (0U))))) | (hsc->Init.Prescaler))));


  (((hsc->Instance->GTPR)) = ((((((hsc->Instance->GTPR))) & (~((0xFFUL << (8U))))) | (((hsc->Init.GuardTime)<<8U)))));
  ...
  ((hsc->Instance->CR2) &= ~((0x1UL << (14U))));
  ((hsc->Instance->CR3) &= ~(((0x1UL << (1U)) | (0x1UL << (3U)))));


  ((hsc->Instance->CR1) |= ((0x1UL << (8U))));


  ((hsc->Instance->CR3) |= ((0x1UL << (0U))));


  ((hsc)->Instance->CR1 |= (0x1UL << (13U)));


  (((hsc->Instance->CR3)) = ((((((hsc->Instance->CR3))) & (~((0x1UL << (4U))))) | (hsc->Init.NACKState))));


  hsc->Instance->CR3 |= ((0x1UL << (5U)));


  hsc->ErrorCode = 0x00000000U;
...
HAL_StatusTypeDef HAL_SMARTCARD_DeInit(SMARTCARD_HandleTypeDef *hsc)
{
  ...
  ((hsc)->Instance->CR1 &= ~(0x1UL << (13U)));
# 403 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
  ...
  do{ (hsc)->Lock = HAL_UNLOCKED; }while (0U);
...
# 759 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Transmit(SMARTCARD_HandleTypeDef *hsc, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint8_t *tmp = pData;
  ...
  if(hsc->gState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    do{ if((hsc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hsc)->Lock = HAL_LOCKED; } }while (0U);
    ...
    {
      hsc->TxXferCount--;
      if(SMARTCARD_WaitOnFlagUntilTimeout(hsc, ((uint32_t)(0x1UL << (7U))), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
    ...
    if(SMARTCARD_WaitOnFlagUntilTimeout(hsc, ((uint32_t)(0x1UL << (6U))), RESET, tickstart, Timeout) != HAL_OK)
    {
      return HAL_TIMEOUT;
    }
...
# 821 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Receive(SMARTCARD_HandleTypeDef *hsc, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint8_t *tmp = pData;
  uint32_t tickstart = 0U;
  ...
  if(hsc->RxState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    {
      hsc->RxXferCount--;
      if(SMARTCARD_WaitOnFlagUntilTimeout(hsc, ((uint32_t)(0x1UL << (5U))), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
...
# 879 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Transmit_IT(SMARTCARD_HandleTypeDef *hsc, uint8_t *pData, uint16_t Size)
{
...
# 927 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Receive_IT(SMARTCARD_HandleTypeDef *hsc, uint8_t *pData, uint16_t Size)
{
  ...
  if(hsc->RxState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    ((hsc->Instance->CR1) |= ((0x1UL << (8U))| (0x1UL << (5U))));
...
# 972 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Transmit_DMA(SMARTCARD_HandleTypeDef *hsc, uint8_t *pData, uint16_t Size)
{
  uint32_t *tmp;
  ...
  if(hsc->gState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    hsc->hdmatx->XferAbortCallback = 0;
    ...
    ((hsc)->Instance->SR = ~(((uint32_t)(0x1UL << (6U)))));
...
# 1034 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Receive_DMA(SMARTCARD_HandleTypeDef *hsc, uint8_t *pData, uint16_t Size)
{
  uint32_t *tmp;
  ...
  if(hsc->RxState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (hsc)->Instance->SR; tmpreg = (hsc)->Instance->DR; (void)tmpreg; } while(0U);
...
# 1104 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Abort(SMARTCARD_HandleTypeDef *hsc)
{

  ((hsc->Instance->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U)))));
  ((hsc->Instance->CR3) &= ~((0x1UL << (0U))));


  if((((hsc->Instance->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U)))))
  {
    ((hsc->Instance->CR3) &= ~((0x1UL << (7U))));
  ...
  if((((hsc->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))))
  {
    ((hsc->Instance->CR3) &= ~((0x1UL << (6U))));
    ...
    if(hsc->hdmarx != 0)
    {
      ...
      hsc->hdmarx->XferAbortCallback = 0;
...
# 1168 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_AbortTransmit(SMARTCARD_HandleTypeDef *hsc)
{

  ((hsc->Instance->CR1) &= ~(((0x1UL << (7U)) | (0x1UL << (6U)))));
...
# 1210 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_AbortReceive(SMARTCARD_HandleTypeDef *hsc)
{

  ((hsc->Instance->CR1) &= ~(((0x1UL << (5U)) | (0x1UL << (8U)))));
  ((hsc->Instance->CR3) &= ~((0x1UL << (0U))));
...
# 1255 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_Abort_IT(SMARTCARD_HandleTypeDef *hsc)
{
...
# 1382 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_AbortTransmit_IT(SMARTCARD_HandleTypeDef *hsc)
{
...
# 1459 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_StatusTypeDef HAL_SMARTCARD_AbortReceive_IT(SMARTCARD_HandleTypeDef *hsc)
{
...
void HAL_SMARTCARD_IRQHandler(SMARTCARD_HandleTypeDef *hsc)
{
  uint32_t isrflags = ((hsc->Instance->SR));
  uint32_t cr1its = ((hsc->Instance->CR1));
  uint32_t cr3its = ((hsc->Instance->CR3));
  ...
  if((errorflags != RESET) && (((cr3its & (0x1UL << (0U))) != RESET) || ((cr1its & ((0x1UL << (5U)) | (0x1UL << (8U)))) != RESET)))
  {
    ...
    if(((isrflags & ((uint32_t)(0x1UL << (0U)))) != RESET) && ((cr1its & (0x1UL << (8U))) != RESET))
    {
      hsc->ErrorCode |= 0x00000001U;
    }


    if(((isrflags & ((uint32_t)(0x1UL << (1U)))) != RESET) && ((cr3its & (0x1UL << (0U))) != RESET))
    {
      hsc->ErrorCode |= 0x00000004U;
    }


    if(((isrflags & ((uint32_t)(0x1UL << (2U)))) != RESET) && ((cr3its & (0x1UL << (0U))) != RESET))
    {
      hsc->ErrorCode |= 0x00000002U;
    }


    if(((isrflags & ((uint32_t)(0x1UL << (3U)))) != RESET) && (((cr1its & (0x1UL << (5U))) != RESET) || ((cr3its & (0x1UL << (0U))) != RESET)))
    {
      hsc->ErrorCode |= 0x00000008U;
    }

    if(hsc->ErrorCode != 0x00000000U)
    {
      ...
      dmarequest = (((hsc->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))));
      if(((hsc->ErrorCode & 0x00000008U) != RESET) || dmarequest)
      {
  ...
  if(((isrflags & ((uint32_t)(0x1UL << (7U)))) != RESET) && ((cr1its & (0x1UL << (7U))) != RESET))
  {
  ...
  if(((isrflags & ((uint32_t)(0x1UL << (6U)))) != RESET) && ((cr1its & (0x1UL << (6U))) != RESET))
  {
...
__attribute__((weak)) void HAL_SMARTCARD_AbortCpltCallback (SMARTCARD_HandleTypeDef *hsc)
{
...
__attribute__((weak)) void HAL_SMARTCARD_AbortTransmitCpltCallback (SMARTCARD_HandleTypeDef *hsc)
{
...
__attribute__((weak)) void HAL_SMARTCARD_AbortReceiveCpltCallback (SMARTCARD_HandleTypeDef *hsc)
{
...
# 1783 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
HAL_SMARTCARD_StateTypeDef HAL_SMARTCARD_GetState(SMARTCARD_HandleTypeDef *hsc)
{
...
# 1840 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static void SMARTCARD_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
...
static void SMARTCARD_DMAError(DMA_HandleTypeDef *hdma)
{
  ...
  hsc->RxXferCount = 0U;
  hsc->TxXferCount = 0U;
  hsc->ErrorCode = 0x00000010U;


  dmarequest = (((hsc->Instance->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U))));
...
# 1933 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static HAL_StatusTypeDef SMARTCARD_WaitOnFlagUntilTimeout(SMARTCARD_HandleTypeDef *hsc, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
{

  while(((((hsc)->Instance->SR & (Flag)) == (Flag)) ? SET : RESET) == Status)
  {
...
# 1982 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static void SMARTCARD_EndRxTransfer(SMARTCARD_HandleTypeDef *hsc)
{
...
# 2127 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static void SMARTCARD_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  SMARTCARD_HandleTypeDef* hsc = ( SMARTCARD_HandleTypeDef* )((DMA_HandleTypeDef* )hdma)->Parent;
  ...
  if(hsc->hdmarx != 0)
  {
    if(hsc->hdmarx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
# 2170 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static void SMARTCARD_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  SMARTCARD_HandleTypeDef* hsc = ( SMARTCARD_HandleTypeDef* )((DMA_HandleTypeDef* )hdma)->Parent;
  ...
  if(hsc->hdmatx != 0)
  {
    if(hsc->hdmatx->XferAbortCallback != 0)
    {
      return;
    }
  }
...
# 2213 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static void SMARTCARD_DMATxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  SMARTCARD_HandleTypeDef* hsc = ( SMARTCARD_HandleTypeDef* )((DMA_HandleTypeDef* )hdma)->Parent;
...
# 2239 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_smartcard.c"
static void SMARTCARD_DMARxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  SMARTCARD_HandleTypeDef* hsc = ( SMARTCARD_HandleTypeDef* )((DMA_HandleTypeDef* )hdma)->Parent;
...
static void SMARTCARD_SetConfig(SMARTCARD_HandleTypeDef *hsc)
{
  ...
  ((hsc->Instance->CR1) &= ~(((0x1UL << (3U)) | (0x1UL << (2U)))));


  tmpreg = hsc->Instance->CR2;

  tmpreg &= (uint32_t)~((uint32_t)((0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (11U)) | (0x1UL << (8U))));





  tmpreg |= (uint32_t)((0x1UL << (11U)) | hsc->Init.CLKPolarity |
  ...
  tmpreg &= (uint32_t)~((uint32_t)(0x3UL << (12U)));
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x1UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U))));
  ...
  ((hsc->Instance->CR3) &= ~(((0x1UL << (8U)) | (0x1UL << (9U)))));



  if((hsc->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || (hsc->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))
  {
    pclk = HAL_RCC_GetPCLK2Freq();
    hsc->Instance->BRR = ((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*((uint64_t)(((hsc->Init.BaudRate)))))))/100U) << 4U) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*((uint64_t)(((hsc->Init.BaudRate))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(4U*((uint64_t)((((hsc->Init.BaudRate))))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0xF0U)) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*((uint64_t)(((hsc->Init.BaudRate))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(4U*((uint64_t)((((hsc->Init.BaudRate))))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0x0FU));
  }

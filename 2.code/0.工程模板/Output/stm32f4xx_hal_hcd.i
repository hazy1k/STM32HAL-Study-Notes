# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c" 2
# 57 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 58 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c" 2
# 80 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
static void HCD_HC_IN_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum);
static void HCD_HC_OUT_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum);
static void HCD_RXQLVL_IRQHandler(HCD_HandleTypeDef *hhcd);
static void HCD_Port_IRQHandler(HCD_HandleTypeDef *hhcd);
# 111 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HAL_StatusTypeDef HAL_HCD_Init(HCD_HandleTypeDef *hhcd)
{
...
# 148 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 201 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 249 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HAL_StatusTypeDef HAL_HCD_HC_Halt(HCD_HandleTypeDef *hhcd, uint8_t ch_num)
{
...
HAL_StatusTypeDef HAL_HCD_DeInit(HCD_HandleTypeDef *hhcd)
{
  ...
  hhcd->State = HAL_HCD_STATE_BUSY;
# 285 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 367 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 704 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
# 1019 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HAL_StatusTypeDef HAL_HCD_Start(HCD_HandleTypeDef *hhcd)
{
  do{ if((hhcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hhcd)->Lock = HAL_LOCKED; } }while (0U);
...
# 1078 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HCD_StateTypeDef HAL_HCD_GetState(HCD_HandleTypeDef *hhcd)
{
  return hhcd->State;
}
# 1097 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HCD_URBStateTypeDef HAL_HCD_HC_GetURBState(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  return hhcd->hc[chnum].urb_state;
}
# 1110 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
uint32_t HAL_HCD_HC_GetXferCount(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  return hhcd->hc[chnum].xfer_count;
}
# 1132 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
HCD_HCStateTypeDef HAL_HCD_HC_GetState(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
...
# 1175 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
static void HCD_HC_IN_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  USB_OTG_GlobalTypeDef *USBx = hhcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (0U))) == (0x1UL << (0U)))
  {
    ...
    {
      hhcd->hc[ch_num].xfer_count = hhcd->hc[ch_num].XferSize - (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCTSIZ & (0x7FFFFUL << (0U)));
...
# 1384 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
static void HCD_HC_OUT_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  USB_OTG_GlobalTypeDef *USBx = hhcd->Instance;
  uint32_t USBx_BASE = (uint32_t)USBx;
  ...
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (0U))) == (0x1UL << (0U)))
  {
    ...
    if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (6U))) == (0x1UL << (6U)))
    {
...
static void HCD_RXQLVL_IRQHandler(HCD_HandleTypeDef *hhcd)
{
  ...
  ch_num = GrxstspReg & (0xFUL << (0U));
  pktsts = (GrxstspReg & (0xFUL << (17U))) >> 17;
  pktcnt = (GrxstspReg & (0x7FFUL << (4U))) >> 4;
    ...
    case 2U:
      ...
      if ((pktcnt > 0U) && (hhcd->hc[ch_num].xfer_buff != (void *)0))
      {
        if ((hhcd->hc[ch_num].xfer_count + pktcnt) <= hhcd->hc[ch_num].xfer_len)
        {
          ...
          xferSizePktCnt = (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCTSIZ & (0x3FFUL << (19U))) >> 19;
...
static void HCD_Port_IRQHandler(HCD_HandleTypeDef *hhcd)
{
  ...
  hprt0_dup &= ~((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (3U)) | (0x1UL << (5U)));

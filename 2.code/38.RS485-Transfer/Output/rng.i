# 1 "../User/BSP/rng/rng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/rng/rng.c" 2
...
{
    uint16_t retry = 0;
    rng_hangle.Instance = ((RNG_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x60800UL));
    HAL_RNG_DeInit(&rng_hangle);
    HAL_RNG_Init(&rng_hangle);
    while((((&rng_hangle)->Instance->SR & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) == RESET && retry < 10000)
    {
        retry++;
        delay_us(10);
    }
...
void HAL_RNG_MspInit(RNG_HandleTypeDef *hRNG)
{
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) |= ((0x1UL << (6U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) & ((0x1UL << (6U)))); (void)tmpreg; } while(0U);
}

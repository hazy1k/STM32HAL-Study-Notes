# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c" 2
# 223 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
...
# 224 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c" 2
# 271 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Init(DAC_HandleTypeDef *hdac)
{
  ...
  {
# 302 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
...
HAL_StatusTypeDef HAL_DAC_DeInit(DAC_HandleTypeDef *hdac)
{
  ...
  hdac->State = HAL_DAC_STATE_BUSY;
# 355 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
...
# 435 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Start(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  ...
  ((hdac)->Instance->CR |= ((0x1UL << (0U)) << ((Channel) & 0x10UL)));

  if (Channel == 0x00000000U)
  {

    if ((hdac->Instance->CR & ((0x1UL << (2U)) | (0x7UL << (3U)))) == ((0x7UL << (3U)) | (0x1UL << (2U))))
    {

      ((hdac->Instance->SWTRIGR) |= ((0x1UL << (0U))));
    }
  }
  ...
  else
  {
    ...
    if ((hdac->Instance->CR & ((0x1UL << (18U)) | (0x7UL << (19U)))) == (((0x7UL << (3U)) | (0x1UL << (2U))) << (Channel & 0x10UL)))
    {

      ((hdac->Instance->SWTRIGR) |= ((0x1UL << (1U))));
    }
  }
...
# 490 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Stop(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
...
# 522 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Start_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t *pData, uint32_t Length,
                                    uint32_t Alignment)
{
...
# 654 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  ...
  hdac->Instance->CR &= ~((0x1UL << (12U)) << (Channel & 0x10UL));
...
# 702 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
void HAL_DAC_IRQHandler(DAC_HandleTypeDef *hdac)
{
  if ((((hdac)->Instance->CR & (((0x1UL << (13U))))) == (((0x1UL << (13U))))))
  {

    if (((((hdac)->Instance->SR) & (((0x1UL << (13U))))) == (((0x1UL << (13U))))))
    {
  ...
  if ((((hdac)->Instance->CR & (((0x1UL << (29U))))) == (((0x1UL << (29U))))))
  {

    if (((((hdac)->Instance->SR) & (((0x1UL << (29U))))) == (((0x1UL << (29U))))))
    {
...
# 775 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_SetValue(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Alignment, uint32_t Data)
{
  ...
  if (Channel == 0x00000000U)
  {
    tmp += (0x00000008UL + (Alignment));
  }

  else
  {
    tmp += (0x00000014UL + (Alignment));
  }
...
# 896 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
uint32_t HAL_DAC_GetValue(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  uint32_t tmp = 0U;
...
# 928 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef *hdac, DAC_ChannelConfTypeDef *sConfig, uint32_t Channel)
{
  uint32_t tmpreg1;
  uint32_t tmpreg2;
  ...
  tmpreg1 &= ~(((uint32_t)((0xFUL << (8U)) | (0x3UL << (6U)) | (0x7UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (1U)))) << (Channel & 0x10UL));
  ...
  ((hdac->Instance->CR) &= ~(((0x3UL << (6U)) << (Channel & 0x10UL))));
...
# 995 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
HAL_DAC_StateTypeDef HAL_DAC_GetState(DAC_HandleTypeDef *hdac)
{

  return hdac->State;
}
# 1008 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
uint32_t HAL_DAC_GetError(DAC_HandleTypeDef *hdac)
{
  return hdac->ErrorCode;
}
# 1274 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dac.c"
void DAC_DMAConvCpltCh1(DMA_HandleTypeDef *hdma)
{

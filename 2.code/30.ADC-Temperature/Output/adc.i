...
uint32_t adc_get_result(uint32_t ch)
{
    adc_channel_set(&adc_handle, ch, 1, ((uint32_t)(0x7UL << (0U))));
...
{
    adc_init();
    ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR |= 1<<23;
}
...
short adc_get_temp(void)
{
    ...
    short result = 0;
    double temp;
    adc_val = adc_get_result_average(((uint32_t)((uint32_t)(0x10UL << (0U)))), 10);

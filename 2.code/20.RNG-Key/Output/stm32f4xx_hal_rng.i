# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c" 2
# 96 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
...
# 97 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c" 2
# 155 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
{
  ...
  ((void)0U);
# 183 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
  ...
  ((hrng)->Instance->CR |= (0x1UL << (2U)));


  hrng->State = HAL_RNG_STATE_READY;


  hrng->ErrorCode = 0x00000000U;
...
HAL_StatusTypeDef HAL_RNG_DeInit(RNG_HandleTypeDef *hrng)
{
  ...
  ((hrng->Instance->CR) &= ~((0x1UL << (3U)) | (0x1UL << (2U))));


  ((hrng->Instance->SR) &= ~((0x1UL << (5U)) | (0x1UL << (6U))));
# 240 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
  ...
  do{ (hrng)->Lock = HAL_UNLOCKED; }while (0U);
...
# 543 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
HAL_StatusTypeDef HAL_RNG_GenerateRandomNumber(RNG_HandleTypeDef *hrng, uint32_t *random32bit)
{
  uint32_t tickstart;
  ...
  do{ if((hrng)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hrng)->Lock = HAL_LOCKED; } }while (0U);
  ...
  if (hrng->State == HAL_RNG_STATE_READY)
  {
    ...
    while ((((hrng)->Instance->SR & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) == RESET)
    {
      if ((HAL_GetTick() - tickstart) > 2U)
      {
        hrng->State = HAL_RNG_STATE_READY;
        hrng->ErrorCode = 0x00000002U;
...
# 632 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
uint32_t HAL_RNG_GetRandomNumber(RNG_HandleTypeDef *hrng)
{
...
# 651 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
uint32_t HAL_RNG_GetRandomNumber_IT(RNG_HandleTypeDef *hrng)
{
...
# 692 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
void HAL_RNG_IRQHandler(RNG_HandleTypeDef *hrng)
{
  uint32_t rngclockerror = 0U;


  if ((((hrng)->Instance->SR & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) != RESET)
  {

    hrng->ErrorCode = 0x00000010U;
    rngclockerror = 1U;
  }
  else if ((((hrng)->Instance->SR & ((0x1UL << (6U)))) == ((0x1UL << (6U)))) != RESET)
  {

    hrng->ErrorCode = 0x00000008U;
    rngclockerror = 1U;
  }
  else
  {
  ...
  if ((((hrng)->Instance->SR & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) != RESET)
  {
...
# 776 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
...
# 826 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
HAL_RNG_StateTypeDef HAL_RNG_GetState(RNG_HandleTypeDef *hrng)
{
  return hrng->State;
}

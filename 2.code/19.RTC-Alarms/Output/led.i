# 1 "../User/BSP/led/led.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/led/led.c" 2
...
# 5 "../User/BSP/led\\led.h" 2
# 16 "../User/BSP/led\\led.h"
void bsp_led_init(void);
# 2 "../User/BSP/led/led.c" 2
...
void bsp_led_init(void)
{
    ...
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), &GPIO_InitStructure);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0200)|((uint16_t)0x0400), GPIO_PIN_SET);
}

# 1 "../User/SYSTEM/delay/delay.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/SYSTEM/delay/delay.c" 2
...
void delay_us(uint32_t nus);
    ...
    void HAL_Delay(uint32_t Delay);
# 3 "../User/SYSTEM/delay/delay.c" 2


static uint32_t g_fac_us = 0;
# 88 "../User/SYSTEM/delay/delay.c"
void delay_init(uint16_t sysclk)
{
    ...
    g_fac_us = sysclk;
# 104 "../User/SYSTEM/delay/delay.c"
}
# 113 "../User/SYSTEM/delay/delay.c"
void delay_us(uint32_t nus)
{
    uint32_t ticks;

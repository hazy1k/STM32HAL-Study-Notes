...
void pwmdac_init(uint16_t arr, uint16_t psc)
{
    tim_handle.Instance = ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x4000UL));
    tim_handle.Init.Prescaler = psc;
    tim_handle.Init.Period = arr;
    tim_handle.Init.CounterMode = 0x00000000U;
    HAL_TIM_PWM_Init(&tim_handle);

    tim_oc_init.OCMode = ((0x4UL << (4U)) | (0x2UL << (4U)));
    tim_oc_init.Pulse = arr/2;
    tim_oc_init.OCPolarity = 0x00000000U;
    HAL_TIM_PWM_ConfigChannel(&tim_handle, &tim_oc_init, 0x00000004U);
    HAL_TIM_PWM_Start(&tim_handle, 0x00000004U);
}

void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim)
{
    GPIO_InitTypeDef gpio_init;
    if(htim->Instance == ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x4000UL)))
    {
        do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (16U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (16U)))); (void)tmpreg; } while(0U);
        ...
        HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), &gpio_init);
    }
}
...
void pwmdac_set_value(uint16_t value)
{
    ...
    temp /= 100;
    temp = temp*256/3.3f;
    (((0x0000000CU) == 0x00000000U) ? ((&tim_handle)->Instance->CCR1 = (temp)) : ((0x0000000CU) == 0x00000004U) ? ((&tim_handle)->Instance->CCR2 = (temp)) : ((0x0000000CU) == 0x00000008U) ? ((&tim_handle)->Instance->CCR3 = (temp)) : ((&tim_handle)->Instance->CCR4 = (temp)));
}

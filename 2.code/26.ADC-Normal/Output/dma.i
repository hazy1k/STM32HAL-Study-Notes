# 1 "../User/BSP/dma/dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/dma/dma.c" 2
...
void dam_uart_init(DMA_Stream_TypeDef *dma_stream_handle, uint32_t ch)
{
    if((uint32_t)dma_stream_handle > (uint32_t)((DMA_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x6400UL)))
    {
    ...
    do{ (&g_uart1_handle)->hdmatx = &(dma_handle); (dma_handle).Parent = (&g_uart1_handle); } while(0U);

    dma_handle.Instance = dma_stream_handle;
    dma_handle.Init.Channel = ch;
    dma_handle.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    dma_handle.Init.PeriphInc = 0x00000000U;
    dma_handle.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    dma_handle.Init.PeriphDataAlignment = 0x00000000U;
    dma_handle.Init.MemDataAlignment = 0x00000000U;
    dma_handle.Init.Mode = 0x00000000U;
    dma_handle.Init.Priority = 0x00000000U;

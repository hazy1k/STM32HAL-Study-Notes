...
# 1 "../User/BSP/24c02\\24c02.h" 1




# 1 "../User/BSP/i2c\\i2c.h" 1
# 18 "../User/BSP/i2c\\i2c.h"
void i2c_start(void);
void i2c_stop(void);
void i2c_ack(void);
void i2c_nack(void);
...
void i2c_init(void);
# 6 "../User/BSP/24c02\\24c02.h" 2
# 20 "../User/BSP/24c02\\24c02.h"
...
int main(void)
{
 ...
 while(1)
 {
  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0010)) == 0)
  {
   ...
   at24cxx_write(0, (uint8_t*)text_buf, sizeof(text_buf));
  ...
  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0008)) == 0)
  {
   ...
   at24cxx_read(0, data, sizeof(text_buf));

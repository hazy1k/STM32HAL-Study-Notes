# 1 "../User/BSP/gtim/gtim.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/gtim/gtim.c" 2
# 1 "../User/BSP/gtim/gtim.h" 1
...
# 2 "../User/BSP/gtim/gtim.c" 2
# 1 "../User/BSP/led\\led.h" 1
# 16 "../User/BSP/led\\led.h"
void bsp_led_init(void);
# 3 "../User/BSP/gtim/gtim.c" 2

TIM_HandleTypeDef TIM5_Handle;

volatile CapState_t TIM5CH1_CAP = {0};
# 16 "../User/BSP/gtim/gtim.c"
void TIM5_CH1_Init(uint32_t arr, uint16_t psc)
{
    TIM_IC_InitTypeDef TIM_ICInitStructure;


    TIM5_Handle.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x0C00UL));
    TIM5_Handle.Init.Period = arr;
    TIM5_Handle.Init.Prescaler = psc;
    TIM5_Handle.Init.CounterMode = 0x00000000U;
    TIM5_Handle.Init.ClockDivision = 0x00000000U;
    HAL_TIM_IC_Init(&TIM5_Handle);


    TIM_ICInitStructure.ICPolarity = 0x00000000U;
    TIM_ICInitStructure.ICSelection = (0x1UL << (0U));
    TIM_ICInitStructure.ICPrescaler = 0x00000000U;
    TIM_ICInitStructure.ICFilter = 0;
    HAL_TIM_IC_ConfigChannel(&TIM5_Handle, &TIM_ICInitStructure, 0x00000000U);


    ((&TIM5_Handle)->Instance->DIER |= ((0x1UL << (0U))));
    HAL_TIM_IC_Start_IT(&TIM5_Handle, 0x00000000U);


    ((&TIM5_Handle)->Instance->SR = ~((0x1UL << (0U))));
    ((&TIM5_Handle)->Instance->SR = ~((0x1UL << (1U))));
}
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef *htim)
{
    if(htim->Instance == ((TIM_TypeDef *) (0x40000000UL + 0x0C00UL)))
    {
        ...
        GPIO_InitStructure.Alternate = ((uint8_t)0x02);
...
# 88 "../User/BSP/gtim/gtim.c"
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
    {
        if (TIM5CH1_CAP.status & 0x80) return;

        if (TIM5CH1_CAP.status & 0x40)
        {

            TIM5CH1_CAP.status |= 0x80;
            TIM5CH1_CAP.cap_val = HAL_TIM_ReadCapturedValue(htim, 0x00000000U);


            do{ ((((0x00000000U)) == 0x00000000U) ? (((htim))->Instance->CCER &= ~((0x1UL << (1U)) | (0x1UL << (3U)))) : (((0x00000000U)) == 0x00000004U) ? (((htim))->Instance->CCER &= ~((0x1UL << (5U)) | (0x1UL << (7U)))) : (((0x00000000U)) == 0x00000008U) ? (((htim))->Instance->CCER &= ~((0x1UL << (9U)) | (0x1UL << (11U)))) : (((htim))->Instance->CCER &= ~((0x1UL << (13U)) | (0x1UL << (15U))))); ((((0x00000000U)) == 0x00000000U) ? (((htim))->Instance->CCER |= ((0x00000000U))) : (((0x00000000U)) == 0x00000004U) ? (((htim))->Instance->CCER |= (((0x00000000U)) << 4U)) : (((0x00000000U)) == 0x00000008U) ? (((htim))->Instance->CCER |= (((0x00000000U)) << 8U)) : (((htim))->Instance->CCER |= ((((0x00000000U)) << 12U)))); }while(0);
        }
        else
        {

            TIM5CH1_CAP.status = 0x40;
            TIM5CH1_CAP.cap_val = 0;


            ((htim)->Instance->CNT = (0));
            do{ ((((0x00000000U)) == 0x00000000U) ? (((htim))->Instance->CCER &= ~((0x1UL << (1U)) | (0x1UL << (3U)))) : (((0x00000000U)) == 0x00000004U) ? (((htim))->Instance->CCER &= ~((0x1UL << (5U)) | (0x1UL << (7U)))) : (((0x00000000U)) == 0x00000008U) ? (((htim))->Instance->CCER &= ~((0x1UL << (9U)) | (0x1UL << (11U)))) : (((htim))->Instance->CCER &= ~((0x1UL << (13U)) | (0x1UL << (15U))))); ((((0x00000000U)) == 0x00000000U) ? (((htim))->Instance->CCER |= (((0x1UL << (1U))))) : (((0x00000000U)) == 0x00000004U) ? (((htim))->Instance->CCER |= ((((0x1UL << (1U)))) << 4U)) : (((0x00000000U)) == 0x00000008U) ? (((htim))->Instance->CCER |= ((((0x1UL << (1U)))) << 8U)) : (((htim))->Instance->CCER |= (((((0x1UL << (1U)))) << 12U)))); }while(0);
        }
    }
}
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == ((TIM_TypeDef *) (0x40000000UL + 0x0C00UL)))
    {
        if ((TIM5CH1_CAP.status & 0x40) && !(TIM5CH1_CAP.status & 0x80))
        {
            uint8_t ovf_count = TIM5CH1_CAP.status & 0x3F;

            if (ovf_count < 0x3F)
            {

                TIM5CH1_CAP.status = (TIM5CH1_CAP.status & ~0x3F) | (ovf_count + 1);
            }
            else
            {

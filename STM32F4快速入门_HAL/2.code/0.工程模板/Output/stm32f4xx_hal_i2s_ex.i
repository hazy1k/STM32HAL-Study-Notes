# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 2
# 91 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
# 92 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c" 2
# 110 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
typedef enum
{
  I2S_USE_I2S = 0x00U,
  I2S_USE_I2SEXT = 0x01U,
} I2S_UseTypeDef;
# 125 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
# 208 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
# 429 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
...
# 541 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
                                                ...
                                                uint16_t Size)
{
  ...
  hi2s->hdmatx->XferHalfCpltCallback = 0;


  hi2s->hdmatx->XferCpltCallback = 0;
...
# 868 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
static void I2SEx_TxRxDMAHalfCplt(DMA_HandleTypeDef *hdma)
{
...
static void I2SEx_TxRxDMACplt(DMA_HandleTypeDef *hdma)
{
  ...
  {
    if (((hi2s->Instance->I2SCFGR & (0x3UL << (8U))) == ((0x2UL << (8U)))) || ((hi2s->Instance->I2SCFGR & (0x3UL << (8U))) == (0x00000000U)))
...
# 1073 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_i2s_ex.c"
static HAL_StatusTypeDef I2SEx_FullDuplexWaitFlagStateUntilTimeout(I2S_HandleTypeDef *hi2s,
                                                                   uint32_t Flag,
                                                                   uint32_t State,
                                                                   uint32_t Timeout,

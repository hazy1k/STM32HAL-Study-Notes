# 1 "../User/SYSTEM/usart/usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/SYSTEM/usart/usart.c" 2
...
# 3 "../User/SYSTEM/usart/usart.c" 2
# 15 "../User/SYSTEM/usart/usart.c"
__asm(".global __use_no_semihosting\n\t");
__asm(".global __ARM_use_no_argv \n\t");
# 33 "../User/SYSTEM/usart/usart.c"
int _ttywrch(int ch)
{
    ch = ch;
    return ch;
...
{
    while ((((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))->SR & 0X40) == 0);

    ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))->DR = (uint8_t)ch;
    return ch;
}
...
# 88 "../User/SYSTEM/usart/usart.c"
void usart_init(uint32_t baudrate)
{
    g_uart1_handle.Instance = ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL));
    ...
    g_uart1_handle.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
    HAL_UART_Init(&g_uart1_handle);


    HAL_UART_Receive_IT(&g_uart1_handle, (uint8_t *)g_rx_buffer, 1);
}
# 110 "../User/SYSTEM/usart/usart.c"
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
    GPIO_InitTypeDef gpio_init_struct;
    if(huart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
    {
        do{ do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (4U)))); (void)tmpreg; } while(0U); }while(0);
        do{ do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0U); }while(0);
        do{ do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0U); }while(0);

        gpio_init_struct.Pin = ((uint16_t)0x0200);
        gpio_init_struct.Mode = (0x00000000U | 0x00000002U);

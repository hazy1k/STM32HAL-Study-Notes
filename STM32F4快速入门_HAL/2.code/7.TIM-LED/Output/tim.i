...
# 13 "../User/BSP/tim/tim.c"
TIM_HandleTypeDef TIM3_Handler;

void BSP_TIM_Init(uint16_t arr, uint16_t psc)
{
    TIM3_Handler.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x0400UL));
    TIM3_Handler.Init.Prescaler = psc;
    TIM3_Handler.Init.CounterMode = 0x00000000U;
    TIM3_Handler.Init.Period = arr;
    TIM3_Handler.Init.ClockDivision = 0x00000000U;

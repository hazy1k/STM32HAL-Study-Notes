...
# 3 "../User/BSP/key/key.c" 2
# 1 "../User/BSP/beep\\beep.h" 1
# 14 "../User/BSP/beep\\beep.h"
void bsp_beep_init(void);
# 4 "../User/BSP/key/key.c" 2
...
void bsp_exti_init(void)
{
    ...
    GPIO_InitStructure.Pin = ((uint16_t)0x0010);
    GPIO_InitStructure.Mode = (0x10000000U | 0x00010000U | 0x00200000U);
    GPIO_InitStructure.Pull = 0x00000001U;
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), &GPIO_InitStructure);
    ...
    GPIO_InitStructure.Pin = ((uint16_t)0x0001);
    GPIO_InitStructure.Mode = (0x10000000U | 0x00010000U | 0x00100000U);
    GPIO_InitStructure.Pull = 0x00000002U;
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), &GPIO_InitStructure);
...
{
    HAL_GPIO_EXTI_IRQHandler(((uint16_t)0x0010));
    (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = (((uint16_t)0x0010)));
}
void EXTI3_IRQHandler(void)
{
    HAL_GPIO_EXTI_IRQHandler(((uint16_t)0x0008));
    (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = (((uint16_t)0x0008)));
}
void EXTI2_IRQHandler(void)
{
    HAL_GPIO_EXTI_IRQHandler(((uint16_t)0x0004));
    (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = (((uint16_t)0x0004)));
}
void EXTI0_IRQHandler(void)
{
    HAL_GPIO_EXTI_IRQHandler(((uint16_t)0x0001));
    (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = (((uint16_t)0x0001)));
}
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
    switch(GPIO_Pin)
    {
        ...
        case ((uint16_t)0x0004):
            HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0100), GPIO_PIN_SET);
            break;
        case ((uint16_t)0x0001):
                HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0100), GPIO_PIN_RESET);
            break;
        default:
            break;
    }

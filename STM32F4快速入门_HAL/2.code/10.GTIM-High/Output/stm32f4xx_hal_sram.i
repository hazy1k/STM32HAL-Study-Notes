# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c" 2
# 116 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
...
# 117 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c" 2
# 165 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Init(SRAM_HandleTypeDef *hsram, FSMC_NORSRAM_TimingTypeDef *Timing, FSMC_NORSRAM_TimingTypeDef *ExtTiming)
{
...
# 190 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
  ...
  ((hsram->Instance)->BTCR[(hsram->Init.NSBank)] |= (0x1UL << (0U)));
...
HAL_StatusTypeDef HAL_SRAM_DeInit(SRAM_HandleTypeDef *hsram)
{
# 227 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
...
# 328 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Read_8b(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint8_t *pDstBuffer, uint32_t BufferSize)
{
...
# 364 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Write_8b(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint8_t *pSrcBuffer, uint32_t BufferSize)
{
  volatile uint8_t * pSramAddress = (uint8_t *)pAddress;
...
# 406 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Read_16b(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint16_t *pDstBuffer, uint32_t BufferSize)
{
...
# 442 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Write_16b(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint16_t *pSrcBuffer, uint32_t BufferSize)
{
  volatile uint16_t * pSramAddress = (uint16_t *)pAddress;
...
# 484 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Read_32b(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint32_t *pDstBuffer, uint32_t BufferSize)
{
...
# 518 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Write_32b(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint32_t *pSrcBuffer, uint32_t BufferSize)
{
...
# 558 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Read_DMA(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint32_t *pDstBuffer, uint32_t BufferSize)
{
...
# 591 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_Write_DMA(SRAM_HandleTypeDef *hsram, uint32_t *pAddress, uint32_t *pSrcBuffer, uint32_t BufferSize)
{
...
# 821 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_StatusTypeDef HAL_SRAM_WriteOperation_Enable(SRAM_HandleTypeDef *hsram)
{
...
# 889 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_sram.c"
HAL_SRAM_StateTypeDef HAL_SRAM_GetState(SRAM_HandleTypeDef *hsram)
{
  return hsram->State;
}

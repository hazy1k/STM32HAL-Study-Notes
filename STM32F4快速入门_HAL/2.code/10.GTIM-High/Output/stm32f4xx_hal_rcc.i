...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c" 2
...
# 70 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c" 2
...
# 593 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c"
HAL_StatusTypeDef HAL_RCC_ClockConfig(RCC_ClkInitTypeDef *RCC_ClkInitStruct, uint32_t FLatency)
{
  uint32_t tickstart;
...
# 777 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c"
void HAL_RCC_MCOConfig(uint32_t RCC_MCOx, uint32_t RCC_MCOSource, uint32_t RCC_MCODiv)
{
  ...
  switch (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U)))
  {
    ...
    case 0x00000008U:
    {
      ...
      else
      {
        ...
        pllvco = (uint32_t) ((((uint64_t) (16000000U) * ((uint64_t) ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> (6U))))) / (uint64_t)pllm);
      }
...
# 979 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c"
...
# 1058 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c"
void HAL_RCC_GetClockConfig(RCC_ClkInitTypeDef *RCC_ClkInitStruct, uint32_t *pFLatency)
{

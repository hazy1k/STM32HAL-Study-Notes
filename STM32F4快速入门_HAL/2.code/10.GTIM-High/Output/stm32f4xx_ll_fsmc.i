# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c" 2
# 57 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
...
# 58 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c" 2
# 129 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NORSRAM_Init(FSMC_Bank1_TypeDef *Device, FSMC_NORSRAM_InitTypeDef* Init)
{
  uint32_t tmpr = 0U;
  ...
  tmpr &= ((uint32_t)~((0x1UL << (0U)) | (0x1UL << (1U)) | (0x3UL << (2U)) | (0x3UL << (4U)) | (0x1UL << (6U)) | (0x1UL << (8U)) | (0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (11U)) | (0x1UL << (12U)) | (0x1UL << (13U)) | (0x1UL << (14U)) | (0x1UL << (15U)) | (0x7UL << (16U)) | (0x1UL << (19U))));
...
# 181 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
                     );
# 208 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
...
# 228 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
  return HAL_OK;
}
# 238 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NORSRAM_DeInit(FSMC_Bank1_TypeDef *Device, FSMC_Bank1E_TypeDef *ExDevice, uint32_t Bank)
{
...
# 275 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NORSRAM_Timing_Init(FSMC_Bank1_TypeDef *Device, FSMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank)
{
  uint32_t tmpr = 0U;
  ...
  tmpr &= ((uint32_t)~((0xFUL << (0U)) | (0xFUL << (4U)) | (0xFFUL << (8U)) | (0xFUL << (16U)) | (0xFUL << (20U)) | (0xFUL << (24U)) | (0x3UL << (28U))));
...
# 319 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
  return HAL_OK;
}
# 330 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NORSRAM_Extended_Timing_Init(FSMC_Bank1E_TypeDef *Device, FSMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank, uint32_t ExtendedMode)
{
  uint32_t tmpr = 0U;
  ...
  if(ExtendedMode == 0x00004000U)
  {
    ...
    tmpr &= ((uint32_t)~((0xFUL << (0U)) | (0xFUL << (4U)) | (0xFFUL << (8U)) | (0xFUL << (16U)) | (0x3UL << (28U))));
...
# 396 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NORSRAM_WriteOperation_Enable(FSMC_Bank1_TypeDef *Device, uint32_t Bank)
{
...
# 483 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NAND_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_InitTypeDef *Init)
{
  uint32_t tmpr = 0U;
  ...
  tmpr &= ((uint32_t)~((0x1UL << (1U)) | (0x1UL << (2U)) | (0x1UL << (3U)) | (0x3UL << (4U)) | (0x1UL << (6U)) | (0xFUL << (9U)) | (0xFUL << (13U)) | (0x7UL << (17U))));
...
# 543 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NAND_CommonSpace_Timing_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank)
{
  uint32_t tmpr = 0U;
  ...
  tmpr &= ((uint32_t)~((0xFFUL << (0U)) | (0xFFUL << (8U)) | (0xFFUL << (16U)) | (0xFFUL << (24U))));
...
# 597 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NAND_AttributeSpace_Timing_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank)
{
  uint32_t tmpr = 0U;
...
HAL_StatusTypeDef FSMC_NAND_DeInit(FSMC_Bank2_3_TypeDef *Device, uint32_t Bank)
{
  ...
  (((Bank) == 0x00000010U)? ((Device)->PCR2 &= ~(0x1UL << (2U))): ((Device)->PCR3 &= ~(0x1UL << (2U))));
...
# 700 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NAND_ECC_Enable(FSMC_Bank2_3_TypeDef *Device, uint32_t Bank)
{

  if(Bank == 0x00000010U)
  {
    Device->PCR2 |= (0x1UL << (6U));
  }
  else
  {
    Device->PCR3 |= (0x1UL << (6U));
  }
...
# 744 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_NAND_GetECC(FSMC_Bank2_3_TypeDef *Device, uint32_t *ECCval, uint32_t Bank, uint32_t Timeout)
{
...
# 838 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_PCCARD_Init(FSMC_Bank4_TypeDef *Device, FSMC_PCCARD_InitTypeDef *Init)
{
  uint32_t tmpr = 0U;
  ...
  tmpr &= ((uint32_t)~((0xFUL << (13U)) | (0xFUL << (9U)) | (0x1UL << (1U)) | (0x3UL << (4U)) | (0x1UL << (3U))));
...
# 872 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_PCCARD_CommonSpace_Timing_Init(FSMC_Bank4_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing)
{
  uint32_t tmpr = 0U;
...
# 906 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_PCCARD_AttributeSpace_Timing_Init(FSMC_Bank4_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing)
{
  uint32_t tmpr = 0U;
...
# 940 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_fsmc.c"
HAL_StatusTypeDef FSMC_PCCARD_IOSpace_Timing_Init(FSMC_Bank4_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing)
{
  uint32_t tmpr = 0U;

...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c" 2
# 199 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
...
# 200 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c" 2
...
# 326 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
...
# 747 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Transmit(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    while (husart->TxXferCount > 0U)
    {
      ...
      if (USART_WaitOnFlagUntilTimeout(husart, ((uint32_t)(0x1UL << (7U))), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
      if (ptxdata8bits == 0)
    ...
    if (USART_WaitOnFlagUntilTimeout(husart, ((uint32_t)(0x1UL << (6U))), RESET, tickstart, Timeout) != HAL_OK)
    {
      return HAL_TIMEOUT;
    }
...
HAL_StatusTypeDef HAL_USART_Receive(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    while (husart->RxXferCount > 0U)
    {
      ...
      husart->Instance->DR = (0xFFFFU & (uint16_t)0x0FF);


      if (USART_WaitOnFlagUntilTimeout(husart, ((uint32_t)(0x1UL << (5U))), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
      ...
      {
        if ((husart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) || ((husart->Init.WordLength == 0x00000000U) && (husart->Init.Parity == 0x00000000U)))
        {
...
# 937 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_TransmitReceive(USART_HandleTypeDef *husart, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  uint8_t *prxdata8bits;
  uint16_t *prxdata16bits;
...
# 1076 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Transmit_IT(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size)
{
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    husart->ErrorCode = 0x00000000U;
    husart->State = HAL_USART_STATE_BUSY_TX;
# 1104 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
    do{ (husart)->Lock = HAL_UNLOCKED; }while (0U);
...
HAL_StatusTypeDef HAL_USART_Receive_IT(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    husart->Instance->DR = (0xFFFFU & (uint16_t)0x01FF);
...
HAL_StatusTypeDef HAL_USART_Transmit_DMA(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    ((husart)->Instance->SR = ~(((uint32_t)(0x1UL << (6U)))));
...
# 1301 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Receive_DMA(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  uint32_t *tmp;
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (husart)->Instance->SR; tmpreg = (husart)->Instance->DR; (void)tmpreg; } while(0U);
...
HAL_StatusTypeDef HAL_USART_DMAStop(USART_HandleTypeDef *husart)
{
  ...
  dmarequest = (((husart->Instance->CR3) & ((0x1UL << (7U)))) == ((0x1UL << (7U))));
  ...
  dmarequest = (((husart->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))));
...
# 1580 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Abort(USART_HandleTypeDef *husart)
{
...
# 1646 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_StatusTypeDef HAL_USART_Abort_IT(USART_HandleTypeDef *husart)
{
...
void HAL_USART_IRQHandler(USART_HandleTypeDef *husart)
{
  ...
  if ((errorflags != RESET) && (((cr3its & (0x1UL << (0U))) != RESET) || ((cr1its & ((0x1UL << (5U)) | (0x1UL << (8U)))) != RESET)))
  {
    ...
    if (husart->ErrorCode != 0x00000000U)
    {
      ...
      dmarequest = (((husart->Instance->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))));
      if (((husart->ErrorCode & 0x00000008U) != RESET) || dmarequest)
      {
...
# 2055 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
HAL_USART_StateTypeDef HAL_USART_GetState(USART_HandleTypeDef *husart)
{
  return husart->State;
}
...
# 2298 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
static HAL_StatusTypeDef USART_WaitOnFlagUntilTimeout(USART_HandleTypeDef *husart, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout)
{
...
static void USART_EndTxTransfer(USART_HandleTypeDef *husart)
{
  ...
  ((husart->Instance->CR1) &= ~(((0x1UL << (7U)) | (0x1UL << (6U)))));
...
# 2390 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
static void USART_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  USART_HandleTypeDef *husart = (USART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 2433 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
static void USART_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  USART_HandleTypeDef *husart = (USART_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
# 2475 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
static HAL_StatusTypeDef USART_Transmit_IT(USART_HandleTypeDef *husart)
{
  uint16_t *tmp;
...
static HAL_StatusTypeDef USART_TransmitReceive_IT(USART_HandleTypeDef *husart)
{
  ...
  if (husart->State == HAL_USART_STATE_BUSY_TX_RX)
  {
    ...
    {
      if ((((husart)->Instance->SR & (((uint32_t)(0x1UL << (7U))))) == (((uint32_t)(0x1UL << (7U))))) != RESET)
      {
        if ((husart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) && (husart->Init.Parity == 0x00000000U))
        {
          pdata8bits = 0;
    ...
    {
      if ((((husart)->Instance->SR & (((uint32_t)(0x1UL << (5U))))) == (((uint32_t)(0x1UL << (5U))))) != RESET)
      {
        if ((husart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) && (husart->Init.Parity == 0x00000000U))
        {
           pdata8bits = 0;
...
static void USART_SetConfig(USART_HandleTypeDef *husart)
{
  ...
  ((husart->Instance->CR1) &= ~(((0x1UL << (3U)) | (0x1UL << (2U)))));


  tmpreg = husart->Instance->CR2;

  tmpreg &= (uint32_t)~((uint32_t)((0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (11U)) | (0x1UL << (8U)) | (0x3UL << (12U))));





  tmpreg |= (uint32_t)(((uint32_t)(0x1UL << (11U))) | husart->Init.CLKPolarity |
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x1UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (15U))));
  ...
  ((husart->Instance->CR3) &= ~(((0x1UL << (8U)) | (0x1UL << (9U)))));
# 2782 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_usart.c"
  if((husart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || (husart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))))
  {
    pclk = HAL_RCC_GetPCLK2Freq();
    husart->Instance->BRR = ((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(2U*((uint64_t)(((husart->Init.BaudRate)))))))/100U) << 4U) + ((((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(2U*((uint64_t)(((husart->Init.BaudRate))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(2U*((uint64_t)((((husart->Init.BaudRate))))))))/100U) * 100U)) * 8U) + 50U) / 100U) & 0xF8U) << 1U)) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(2U*((uint64_t)(((husart->Init.BaudRate))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(2U*((uint64_t)((((husart->Init.BaudRate))))))))/100U) * 100U)) * 8U) + 50U) / 100U) & 0x07U));
  }

...
static uint32_t pulse_remain = 0;
...
void tim8_pwm_init(uint16_t arr, uint16_t psc) {
    ...
    tim8_handle.Instance = ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL));
    tim8_handle.Init.Prescaler = psc;
    tim8_handle.Init.CounterMode = 0x00000000U;
    tim8_handle.Init.Period = arr;
    tim8_handle.Init.AutoReloadPreload = (0x1UL << (7U));
    ...
    HAL_TIM_PWM_ConfigChannel(&tim8_handle, &oc_init, 0x00000000U);


    HAL_NVIC_SetPriority(TIM8_UP_TIM13_IRQn, 1, 3);
    HAL_NVIC_EnableIRQ(TIM8_UP_TIM13_IRQn);
    ((&tim8_handle)->Instance->DIER |= ((0x1UL << (0U))));


    HAL_TIM_PWM_Start(&tim8_handle, 0x00000000U);
}
...
void tim8_set_pulse_count(uint32_t count) {
    ...
    pulse_remain = count;
    HAL_TIM_GenerateEvent(&tim8_handle, (0x1UL << (0U)));
    ((&tim8_handle)->Instance->CR1|=((0x1UL << (0U))));
}


void TIM8_UP_TIM13_IRQHandler(void) {
    if ((((&tim8_handle)->Instance->SR &((0x1UL << (0U)))) == ((0x1UL << (0U))))) {
        uint16_t pulses = 0;
        ...
        if (pulse_remain > 0) {
            ...
            ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL))->RCR = pulses - 1;
            HAL_TIM_GenerateEvent(&tim8_handle, (0x1UL << (0U)));
            ((&tim8_handle)->Instance->CR1|=((0x1UL << (0U))));
        } else {
            ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL))->CR1 &= ~(0x1UL << (0U));
        }

        ((&tim8_handle)->Instance->SR = ~((0x1UL << (0U))));
    }
}

...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c" 2
...
# 111 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c" 2
# 176 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Init(NAND_HandleTypeDef *hnand, FSMC_NAND_PCC_TimingTypeDef *ComSpace_Timing, FSMC_NAND_PCC_TimingTypeDef *AttSpace_Timing)
{
...
# 200 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
  ...
  (((hnand->Init.NandBank) == 0x00000010U)? ((hnand->Instance)->PCR2 |= (0x1UL << (2U))): ((hnand->Instance)->PCR3 |= (0x1UL << (2U))));
...
# 240 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
  ...
  do{ (hnand)->Lock = HAL_UNLOCKED; }while (0U);
...
__attribute__((weak)) void HAL_NAND_MspInit(NAND_HandleTypeDef *hnand)
{
...
__attribute__((weak)) void HAL_NAND_MspDeInit(NAND_HandleTypeDef *hnand)
{
...
# 292 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
void HAL_NAND_IRQHandler(NAND_HandleTypeDef *hnand)
{

  if((((hnand->Init.NandBank) == 0x00000010U)? (((hnand->Instance)->SR2 &(0x00000001U)) == (0x00000001U)): (((hnand->Instance)->SR3 &(0x00000001U)) == (0x00000001U))))
  {
    ...
    (((hnand->Init.NandBank) == 0x00000010U)? ((hnand->Instance)->SR2 &= ~(0x00000001U)): ((hnand->Instance)->SR3 &= ~(0x00000001U)));
  }


  if((((hnand->Init.NandBank) == 0x00000010U)? (((hnand->Instance)->SR2 &(0x00000002U)) == (0x00000002U)): (((hnand->Instance)->SR3 &(0x00000002U)) == (0x00000002U))))
  {
    ...
    (((hnand->Init.NandBank) == 0x00000010U)? ((hnand->Instance)->SR2 &= ~(0x00000002U)): ((hnand->Instance)->SR3 &= ~(0x00000002U)));
  }


  if((((hnand->Init.NandBank) == 0x00000010U)? (((hnand->Instance)->SR2 &(0x00000004U)) == (0x00000004U)): (((hnand->Instance)->SR3 &(0x00000004U)) == (0x00000004U))))
  {
    ...
    (((hnand->Init.NandBank) == 0x00000010U)? ((hnand->Instance)->SR2 &= ~(0x00000004U)): ((hnand->Instance)->SR3 &= ~(0x00000004U)));
  }


  if((((hnand->Init.NandBank) == 0x00000010U)? (((hnand->Instance)->SR2 &(0x00000040U)) == (0x00000040U)): (((hnand->Instance)->SR3 &(0x00000040U)) == (0x00000040U))))
  {
    ...
    (((hnand->Init.NandBank) == 0x00000010U)? ((hnand->Instance)->SR2 &= ~(0x00000040U)): ((hnand->Instance)->SR3 &= ~(0x00000040U)));
  }
}
...
__attribute__((weak)) void HAL_NAND_ITCallback(NAND_HandleTypeDef *hnand)
{
...
HAL_StatusTypeDef HAL_NAND_Read_ID(NAND_HandleTypeDef *hnand, NAND_IDTypeDef *pNAND_ID)
{
  ...
  do{ if((hnand)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hnand)->Lock = HAL_LOCKED; } }while (0U);
  ...
  if(hnand->Init.NandBank == 0x00000010U)
  {
    deviceaddress = 0x70000000U;
  }
  else
  {
    deviceaddress = 0x80000000U;
  }
  ...
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x90);
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = 0x00;



  if (hnand->Init.MemoryDataWidth == 0x00000000U)
...

  {
    ...
    pNAND_ID->Third_Id = (uint8_t)((data) >> 16);
    pNAND_ID->Fourth_Id = (uint8_t)((data) >> 24);
  }
  else
  {
    data = *(volatile uint32_t *)deviceaddress;
    ...
    pNAND_ID->Maker_Id = (uint8_t)(data);
    pNAND_ID->Device_Id = (uint8_t)((data) >> 16);
    pNAND_ID->Third_Id = (uint8_t)(data1);
    pNAND_ID->Fourth_Id = (uint8_t)((data1) >> 16);
  }
...
HAL_StatusTypeDef HAL_NAND_Reset(NAND_HandleTypeDef *hnand)
{
  ...
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = 0xFF;
...
# 535 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Read_Page_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer, uint32_t NumPageToRead)
{
  ...
  nandaddress = ((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Plane) * ((hnand)->Config.PlaneSize)))* ((hnand)->Config.BlockSize)));
  ...
  while((NumPageToRead != 0U) && (nandaddress < ((hnand->Config.BlockSize) * (hnand->Config.BlockNbr))))
  {
    ...
    *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x00);
    ...
    if((hnand->Config.PageSize) <= 512U)
    {
      ...
      {
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = 0x00;
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)(nandaddress);
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((nandaddress) >> 8);
      }
      else
      {
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = 0x00;
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)(nandaddress);
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((nandaddress) >> 8);
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((nandaddress) >> 16);
      }
    }
    else
    {
    ...
    *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x30);
    ...
    if(hnand->Config.ExtraCommandEnable == ENABLE)
    {
      ...
      while(HAL_NAND_Read_Status(hnand) != 0x00000040U)
      {
        if((HAL_GetTick() - tickstart ) > 0x01000000U)
        {
          return HAL_TIMEOUT;
        }
      }
...
HAL_StatusTypeDef HAL_NAND_Write_Page_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer, uint32_t NumPageToWrite)
{
  ...
  while((NumPageToWrite != 0U) && (nandaddress < ((hnand->Config.BlockSize) * (hnand->Config.BlockNbr))))
  {
    ...
    *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x00);
    *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x80);
    ...
    *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x10);
...
# 1084 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Read_SpareArea_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer, uint32_t NumSpareAreaToRead)
{
  volatile uint32_t index = 0U;
  uint32_t tickstart = 0U;
  ...
  columnaddress = ((hnand)->Config.PageSize);
  ...
  while((NumSpareAreaToRead != 0U) && (nandaddress < ((hnand->Config.BlockSize) * (hnand->Config.BlockNbr))))
  {
    ...
    if((hnand->Config.PageSize) <= 512U)
    {
      ...
      *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x50);
    ...
    else
    {
      ...
      *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x00);
      ...
      if (((hnand->Config.BlockSize)*(hnand->Config.BlockNbr)) <= 65535U)
      {
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)(columnaddress);
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((columnaddress) >> 8);
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)(nandaddress);
        *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((nandaddress) >> 8);
      }
      else
...
# 1220 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Read_SpareArea_16b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint16_t *pBuffer, uint32_t NumSpareAreaToRead)
{
  volatile uint32_t index = 0U;
  uint32_t tickstart = 0U;
  ...
  columnaddress = (uint32_t)(((hnand)->Config.PageSize));
...
# 1356 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Write_SpareArea_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer, uint32_t NumSpareAreaTowrite)
{
  volatile uint32_t index = 0U;
  uint32_t tickstart = 0U;
...
# 1488 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Write_SpareArea_16b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint16_t *pBuffer, uint32_t NumSpareAreaTowrite)
{
  volatile uint32_t index = 0U;
  uint32_t tickstart = 0U;
...
# 1618 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_Erase_Block(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress)
{
  uint32_t deviceaddress = 0U;
  uint32_t tickstart = 0U;
  ...
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x60);

  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)(((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Plane) * ((hnand)->Config.PlaneSize)))* ((hnand)->Config.BlockSize))));
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Plane) * ((hnand)->Config.PlaneSize)))* ((hnand)->Config.BlockSize)))) >> 8);
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<17U)))) = (uint8_t)((((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Plane) * ((hnand)->Config.PlaneSize)))* ((hnand)->Config.BlockSize)))) >> 16);

  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0xD0);
...
uint32_t HAL_NAND_Read_Status(NAND_HandleTypeDef *hnand)
{
  ...
  *(volatile uint8_t *)((uint32_t)(deviceaddress | ((uint32_t)(1U<<16U)))) = ((uint8_t)0x70);


  data = *(volatile uint8_t *)deviceaddress;


  if((data & 0x00000001U) == 0x00000001U)
  {
    return 0x00000001U;
  }
  else if((data & 0x00000040U) == 0x00000040U)
  {
    return 0x00000040U;
  }
...
# 1917 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_ECC_Enable(NAND_HandleTypeDef *hnand)
{
...
# 1971 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_StatusTypeDef HAL_NAND_GetECC(NAND_HandleTypeDef *hnand, uint32_t *ECCval, uint32_t Timeout)
{
...
# 2019 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_nand.c"
HAL_NAND_StateTypeDef HAL_NAND_GetState(NAND_HandleTypeDef *hnand)
{
  return hnand->State;
}

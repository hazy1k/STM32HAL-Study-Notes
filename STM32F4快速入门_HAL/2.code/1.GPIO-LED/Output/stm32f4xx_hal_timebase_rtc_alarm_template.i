# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c" 2
# 47 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
...
# 48 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c" 2
# 81 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
RTC_HandleTypeDef hRTC_Handle;

void RTC_Alarm_IRQHandler(void);
# 95 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
...
# 117 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
  ...
  PeriphClkInitStruct.RTCClockSelection = ((uint32_t)((uint32_t)(0x3UL << (8U)) | (uint32_t)(((8000000U)/1000000U) << 16U)));
...
# 148 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
    hRTC_Handle.Instance = ((RTC_TypeDef *) (0x40000000UL + 0x2800UL));
    hRTC_Handle.Init.HourFormat = 0x00000000U;
    hRTC_Handle.Init.AsynchPrediv = 99U;
    hRTC_Handle.Init.SynchPrediv = 9U;
    hRTC_Handle.Init.OutPut = 0x00000000U;
    hRTC_Handle.Init.OutPutPolarity = 0x00000000U;
    hRTC_Handle.Init.OutPutType = 0x00000000U;
    status = HAL_RTC_Init(&hRTC_Handle);
  }
  if (status == HAL_OK)
  {

    do{ (&hRTC_Handle)->Instance->WPR = 0xCAU; (&hRTC_Handle)->Instance->WPR = 0x53U; } while(0U);


    ((&hRTC_Handle)->Instance->CR &= ~((0x1UL << (8U))));


    ((&hRTC_Handle)->Instance->ISR) = (~((0x00000100U) | (0x1UL << (7U)))|((&hRTC_Handle)->Instance->ISR & (0x1UL << (7U))));

    counter = 0U;

    while ((((((&hRTC_Handle)->Instance->ISR) & (0x00000001U)) != RESET)? SET : RESET) == RESET)
    {
  ...
  if (status == HAL_OK)
  {
    ...
    ((&hRTC_Handle)->Instance->CR |= (0x00001000U));
    ...
    if ((hRTC_Handle.Instance->ISR & (0x1UL << (6U))) == (uint32_t)RESET)
    {

      hRTC_Handle.Instance->ISR = (uint32_t)0xFFFFFFFFU;
      counter = 0U;
      while ((hRTC_Handle.Instance->ISR & (0x1UL << (6U))) == (uint32_t)RESET)
      {
        if (counter++ == (SystemCoreClock / 48U))
        {
          status = HAL_ERROR;
  ...
  if (status == HAL_OK)
  {
    ...
    hRTC_Handle.Instance->ISR &= (uint32_t)~(0x1UL << (7U));


    do{ (&hRTC_Handle)->Instance->WPR = 0xFFU; } while(0U);
...
# 272 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_rtc_alarm_template.c"
void HAL_RTC_AlarmAEventCallback(RTC_HandleTypeDef *hrtc)
{
  volatile uint32_t counter = 0U;

# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c" 2
# 27 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c"
...
# 28 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c" 2
# 41 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c"
TIM_HandleTypeDef TimHandle;

void TIM6_DAC_IRQHandler(void);
# 55 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c"
HAL_StatusTypeDef HAL_InitTick (uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (4U)))); (void)tmpreg; } while(0U);
  ...
  TimHandle.Init.AutoReloadPreload = 0x00000000U;
...
# 156 "../Libraries/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_timebase_tim_template.c"
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  HAL_IncTick();
}

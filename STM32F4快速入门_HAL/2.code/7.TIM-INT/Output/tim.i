# 1 "../User/BSP/tim/tim.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/BSP/tim/tim.c" 2
...
void BSP_TIM_Init(uint16_t arr, uint16_t psc)
{
    TIM6_Handler.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x1000UL));
    TIM6_Handler.Init.Prescaler = psc;
    TIM6_Handler.Init.CounterMode = 0x00000000U;
    TIM6_Handler.Init.Period = arr;
    TIM6_Handler.Init.ClockDivision = 0x00000000U;
